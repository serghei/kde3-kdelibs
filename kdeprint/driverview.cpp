...
DrListView::DrListView(QWidget *parent, const char *name) : KListView(parent, name)
{
    addColumn("");
    header()->hide();
...
DriverView::DriverView(QWidget *parent, const char *name) : QWidget(parent, name)
{
    // WhatsThis strings.... (added by pfeifle@kde.org)
    QString whatsThisPPDOptionsDriverPage = i18n(
        " <qt> "
    ...
    QString whatsThisOptionSettingsDriverPage = i18n(
        " <qt> "
