...
KFileList::KFileList(QWidget *parent, const char *name) : QWidget(parent, name)
{
    ...
    QToolTip::add(m_files, i18n("Drag file(s) here or use the button to open a file dialog. "
