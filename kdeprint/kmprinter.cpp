...
KMPrinter::KMPrinter(const KMPrinter &p) : KMObject()
{
...
QString KMPrinter::stateString() const
{
    ...
    switch(state())
    {
        ...
        case KMPrinter::Stopped:
            ...
            break;
        default:
            return i18n("Unknown State", "Unknown");
    }
...
bool KMPrinter::autoConfigure(KPrinter *printer, QWidget *parent)
{
    ...
    if(isSpecial())
    {
        if(option("kde-special-file") == "1")
        {
            ...
            KFileDialog *dialog = new KFileDialog(fName, QString::null, parent, "filedialog", true);
