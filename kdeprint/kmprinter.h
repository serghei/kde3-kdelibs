...
public:
    ...
    {
        m_state = PrinterState((m_state & ~StateMask) | s);
    }
    ...
    {
        m_state = PrinterState((m_state & StateMask) | (on ? 0 : Rejecting));
    }
