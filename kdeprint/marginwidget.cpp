...
MarginWidget::MarginWidget(QWidget *parent, const char *name, bool allowMetricUnit) : QWidget(parent, name), m_default(4, 0), m_pagesize(2)
{
    // WhatsThis strings.... (added by pfeifle@kde.org)
    QString whatsThisTopMarginWidget = i18n(
        " <qt> "
        " <p><b>Top Margin</b></p>. "
