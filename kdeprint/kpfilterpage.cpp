...
KPFilterPage::KPFilterPage(QWidget *parent, const char *name) : KPrintDialogPage(parent, name)
{
    // WhatsThis strings.... (added by pfeifle@kde.org)
    QString whatsThisAddFilterButton = i18n(
    ...
    QString whatsThisFilterInfoPane = i18n(
    ...
    QString whatsThisFilterchainListView = i18n(
...
bool KPFilterPage::isValid(QString &msg)
{
    ...
    {
        msg = i18n(
            "<p>The filter chain is wrong. The output format of at least one filter is not supported by its follower. See <b>Filters</b> tab for "
            "more information.</p>");
    }
    return m_valid;
}
