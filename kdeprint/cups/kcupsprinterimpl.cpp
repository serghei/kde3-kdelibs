...
KCupsPrinterImpl::KCupsPrinterImpl(QObject *parent, const char *name, const QStringList & /*args*/) : KPrinterImpl(parent, name)
{
}
...
void KCupsPrinterImpl::preparePrinting(KPrinter *printer)
{
    ...
    { // Qt => CUPS
        ...
        printer->setOption("multiple-document-handling", (printer->option("kde-collate") == "Collate" ? "separate-documents-collated-copies"
