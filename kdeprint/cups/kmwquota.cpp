...
static const char *time_keywords[] = {I18N_NOOP("second(s)"), I18N_NOOP("minute(s)"), I18N_NOOP("hour(s)"),
                                      I18N_NOOP("day(s)"),    I18N_NOOP("week(s)"),   I18N_NOOP("month(s)")};
...
KMWQuota::KMWQuota(QWidget *parent, const char *name) : KMWizardPage(parent, name)
{
