...
CupsdSplash::CupsdSplash(QWidget *parent, const char *name) : CupsdPage(parent, name)
{
    ...
    helptxt_->setText(
        i18n("<p>This tool will help you to configure graphically the server of the CUPS printing system. "
