...
PortValidator::PortValidator(QWidget *parent, const char *name) : QIntValidator(1, 65535, parent, name)
{
}
...
KMCupsConfigWidget::KMCupsConfigWidget(QWidget *parent, const char *name) : QWidget(parent, name)
{
    // widget creation
