...
static struct
{
    const char *banner;
    const char *name;
} bannermap[] = {{"none", I18N_NOOP("No Banner")},
...
KMWBanners::KMWBanners(QWidget *parent, const char *name) : KMWizardPage(parent, name)
{
    ...
    l0->setText(
        i18n("<p>Select the default banners associated with this printer. These "
