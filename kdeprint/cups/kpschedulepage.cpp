...
KPSchedulePage::KPSchedulePage(QWidget *parent, const char *name) : KPrintDialogPage(parent, name)
{
    // WhatsThis strings.... (added by pfeifle@kde.org)
    QString whatsThisBillingInfo = i18n(
...
void KPSchedulePage::setOptions(const QMap< QString, QString > &opts)
{
    ...
    if(!t.isEmpty())
    {
        ...
        if(t == "no-hold")
            ...
            item = 5;
        else if(t == "second-shift")
            item = 6;
        else if(t == "third-shift")
            item = 7;
        else
        {
