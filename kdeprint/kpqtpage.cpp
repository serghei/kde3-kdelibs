...
KPQtPage::KPQtPage(QWidget *parent, const char *name) : KPrintDialogPage(parent, name)
{
    init();
}
...
void KPQtPage::init()
{
    ...
    QString whatsThisColorModeOtPageLabel = i18n(
        " <qt> "
        ...
        " </qt>");
    QString whatsThisPageSizeOtPageLabel = i18n(
        " <qt> "
        ...
        " </qt>");
    QString whatsThisPagesPerSheetOtPageLabel = i18n(
        " <qt> "
        ...
        " </ul>"
        " </qt>");
    QString whatsThisOrientationOtPageLabel = i18n(
        " <qt> "
    ...
    if(KPrinter::applicationType() != KPrinter::Dialog && KPrinter::applicationType() >= 0)
    {
...
void KPQtPage::slotNupChanged(int ID)
{
    ...
    {
        case NUP_1:
            pixstr = "kdeprint_nup1";
            break;
        case NUP_2:
            pixstr = "kdeprint_nup2";
            break;
        case NUP_4:
            pixstr = "kdeprint_nup4";
            break;
        case NUP_OTHER:
            pixstr = "kdeprint_nupother";
            break;
    }
