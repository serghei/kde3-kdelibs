...
OptionBaseView::OptionBaseView(QWidget *parent, const char *name) : QWidget(parent, name)
{
    blockSS = false;
}
...
OptionNumericView::OptionNumericView(QWidget *parent, const char *name) : OptionBaseView(parent, name)
{
...
OptionStringView::OptionStringView(QWidget *parent, const char *name) : OptionBaseView(parent, name)
{
    m_edit = new QLineEdit(this);
...
OptionListView::OptionListView(QWidget *parent, const char *name) : OptionBaseView(parent, name)
{
...
OptionBooleanView::OptionBooleanView(QWidget *parent, const char *name) : OptionBaseView(parent, name)
{
...
DrOptionView::DrOptionView(QWidget *parent, const char *name) : QGroupBox(parent, name)
{
