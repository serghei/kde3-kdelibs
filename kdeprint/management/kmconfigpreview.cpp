...
KMConfigPreview::KMConfigPreview(QWidget *parent, const char *name) : KMConfigPage(parent, name)
{
    ...
    lab->setText(
        i18n("You can use an external preview program (PS viewer) instead of the "
