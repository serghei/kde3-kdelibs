...
KMConfigGeneral::KMConfigGeneral(QWidget *parent) : KMConfigPage(parent, "ConfigTimer")
{
    ...
    lay0->addStretch(1);
    QVBoxLayout *lay1 = new QVBoxLayout(m_timerbox->layout(), KDialog::spacingHint());
    lay1->addWidget(m_timer);
    QVBoxLayout *lay2 = new QVBoxLayout(m_testpagebox->layout(), KDialog::spacingHint());
    ...
    QVBoxLayout *lay4 = new QVBoxLayout(m_statusbox->layout(), KDialog::spacingHint());
