...
KMWName::KMWName(QWidget *parent, const char *name) : KMWInfoBase(3, parent, name)
{
    m_ID = KMWizard::Name;
    ...
    setInfo(
        i18n("<p>Enter the information concerning your printer or class. <b>Name</b> is mandatory, "
...
bool KMWName::isValid(QString &msg)
{
    ...
    else if(text(0).find(QRegExp("\\s")) != -1)
    {
        ...
        int result = KMessageBox::warningYesNoCancel(this, i18n("It is usually not a good idea to include spaces "
                                                               ...
                                                               .arg(conv),
                                                     QString::null, i18n("Strip"), i18n("Keep"));
        switch(result)
        {
