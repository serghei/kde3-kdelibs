...
KMWDriverSelect::KMWDriverSelect(QWidget *parent, const char *name) : KMWizardPage(parent, name)
{
    ...
    l1->setText(
        i18n("<p>Several drivers have been detected for this model. Select the driver "
