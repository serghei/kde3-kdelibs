...
CJanusWidget::CListBox::CListBox(QWidget *parent, const char *name) : KListBox(parent, name)
{
...
CJanusWidget::CJanusWidget(QWidget *parent, const char *name) : QWidget(parent, name)
{
