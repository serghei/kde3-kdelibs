...
bool KMSpecialPrinterDlg::checkSettings()
{
    ...
    if(m_name->text().isEmpty())
        ...
        KXmlCommandManager::self()->checkCommand(m_command->command(), KXmlCommandManager::Basic,
                                                 (m_usefile->isChecked() ? KXmlCommandManager::Basic : KXmlCommandManager::None), &msg);
