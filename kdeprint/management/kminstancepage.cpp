...
KMInstancePage::KMInstancePage(QWidget *parent, const char *name) : QWidget(parent, name)
{
    ...
    QWhatsThis::add(this, i18n("Define/Edit here instances for the current selected "
...
void KMInstancePage::slotNew()
{
    ...
    bool ok(false);
    QString name = KInputDialog::getText(i18n("Instance Name"), i18n("Enter name for new instance (leave untouched for default):"), i18n("(Default)"),
                                         &ok, this);
    if(ok)
    {
...
void KMInstancePage::slotRemove()
{
    ...
    QString msg = (src != i18n("(Default)") ? i18n("Do you really want to remove instance %1?")
                                            : i18n("You can't remove the default instance. However all settings of %1 will be discarded. Continue?"));
