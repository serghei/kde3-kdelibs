...
KMConfigFonts::KMConfigFonts(QWidget *parent, const char *name) : KMConfigPage(parent, name)
{
    ...
    QWhatsThis::add(m_fontpath, i18n("When using font embedding you can select additional directories where "
