...
KXmlCommandAdvancedDlg::KXmlCommandAdvancedDlg(QWidget *parent, const char *name) : QWidget(parent, name)
{
    m_xmlcmd = 0;
    ...
    QGridLayout *l8 = new QGridLayout(gb_input->layout(), 2, 2, KDialog::spacingHint());
    QGridLayout *l9 = new QGridLayout(gb_output->layout(), 2, 2, KDialog::spacingHint());
     ...
     */
    QWhatsThis::add(m_name, i18n("An identification string. Use only alphanumeric characters except spaces. "
                                 "The string <b>__root__</b> is reserved for internal use."));
    QWhatsThis::add(m_namelab, QWhatsThis::textFor(m_name));
    QWhatsThis::add(m_desc, i18n("A description string. This string is shown in the interface, and should "
                                 "be explicit enough about the role of the corresponding option."));
    QWhatsThis::add(m_desclab, QWhatsThis::textFor(m_desc));
    QWhatsThis::add(m_type, i18n("The type of the option. This determines how the option is presented "
                                 "graphically to the user."));
    QWhatsThis::add(m_typelab, QWhatsThis::textFor(m_type));
    QWhatsThis::add(m_format, i18n("The format of the option. This determines how the option is formatted "
    ...
    QWhatsThis::add(m_default, i18n("The default value of the option. For non persistent options, nothing is "
                                    "added to the command line if the option has that default value. If this "
                                    "value does not correspond to the actual default value of the underlying "
                                    "utility, make the option persistent to avoid unwanted effects."));
    QWhatsThis::add(m_defaultlab, QWhatsThis::textFor(m_default));
    QWhatsThis::add(m_persistent, i18n("Make the option persistent. A persistent option is always written to the "
                                       "command line, whatever its value. This is useful when the chosen default "
                                       "value does not match with the actual default value of the underlying utility."));
    QWhatsThis::add(m_command, i18n("The full command line to execute the associated underlying utility. This "
    ...
    QWhatsThis::add(m_inputfile, i18n("Input specification when the underlying utility reads input data from a file. Use "
                                      "the tag <b>%in</b> to represent the input filename."));
    QWhatsThis::add(m_inputfilelab, QWhatsThis::textFor(m_inputfile));
    QWhatsThis::add(m_outputfile, i18n("Output specification when the underlying utility writes output data to a file. Use "
                                       "the tag <b>%out</b> to represent the output filename."));
    QWhatsThis::add(m_outputfilelab, QWhatsThis::textFor(m_outputfile));
    QWhatsThis::add(m_inputpipe, i18n("Input specification when the underlying utility reads input data from its "
                                      "standard input."));
    QWhatsThis::add(m_inputpipelab, QWhatsThis::textFor(m_inputpipe));
    QWhatsThis::add(m_outputpipe, i18n("Output specification when the underlying utility writes output data to its "
                                       "standard output."));
    QWhatsThis::add(m_outputpipelab, QWhatsThis::textFor(m_outputpipe));
    QWhatsThis::add(m_comment, i18n("A comment about the underlying utility, which can be viewed by the user "
...
KXmlCommandDlg::KXmlCommandDlg(QWidget *parent, const char *name) : KDialogBase(parent, name, true, QString::null, Ok | Cancel | Details, Ok, true)
{
