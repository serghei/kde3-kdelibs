...
TreeListBoxItem::TreeListBoxItem(QListBox *lb, const QPixmap &pix, const QString &txt, bool oneBlock) : QListBoxPixmap(pix, txt)
{
    if(oneBlock)
...
TreeListBox::TreeListBox(QWidget *parent, const char *name) : QListBox(parent, name)
{
    m_painting = false;
}
...
TreeComboBox::TreeComboBox(QWidget *parent, const char *name) : QComboBox(parent, name)
{
