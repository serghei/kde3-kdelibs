...
EscpWidget::EscpWidget(QWidget *parent, const char *name) : QWidget(parent, name)
{
    m_hasoutput = false;
...
void EscpWidget::startCommand(const QString &arg)
{
    ...
    else
    {
        ...
        {
            KMessageBox::error(this, i18n("Unsupported connection type: %1").arg(protocol));
            return;
        }
    }
    ...
    {
        KMessageBox::error(this, i18n("Internal error: unable to start escputil process."));
        return;
    }
}
