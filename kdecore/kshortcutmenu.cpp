...
KShortcutMenu::KShortcutMenu(QWidget *pParent, KAccelActions *pActions, KKeySequence seq) : QPopupMenu(pParent), m_pActions(pActions), m_seq(seq)
{
    ...
    switch(pEvent->key())
    {
        ...
        default:
            ...
            if(iItem == -1)
            {
                ...
                if(pEvent->key() == Qt::Key_Up || pEvent->key() == Qt::Key_Down || pEvent->key() == Qt::Key_Enter || pEvent->key() == Qt::Key_Return)
