...
{
    long jdn = ((1461 * (year + 4800 + ((month - 14) / 12))) / 4) + ((367 * (month - 2 - 12 * (((month - 14) / 12)))) / 12)
...
KCalendarSystemJalali::KCalendarSystemJalali(const KLocale *locale) : KCalendarSystem(locale)
{
}
...
QString KCalendarSystemJalali::monthName(int month, int year, bool shortName) const
{
    Q_UNUSED(year);
...
QString KCalendarSystemJalali::monthName(const QDate &date, bool shortName) const
{
    int mon;
...
QString KCalendarSystemJalali::monthNamePossessive(const QDate &date, bool shortName) const
{
    return monthName(date, shortName);
}

QString KCalendarSystemJalali::monthNamePossessive(int month, int year, bool shortName) const
{
...
QString KCalendarSystemJalali::weekDayName(const QDate &date, bool shortName) const
{
