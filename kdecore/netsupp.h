...
#define KDE_IN6_IS_ADDR_UNSPECIFIED(a)                                                                                                               \
    (((Q_UINT32 *)(a))[0] == 0 && ((Q_UINT32 *)(a))[1] == 0 && ((Q_UINT32 *)(a))[2] == 0 && ((Q_UINT32 *)(a))[3] == 0)

#define KDE_IN6_IS_ADDR_LOOPBACK(a)                                                                                                                  \
    (((Q_UINT32 *)(a))[0] == 0 && ((Q_UINT32 *)(a))[1] == 0 && ((Q_UINT32 *)(a))[2] == 0 && ((Q_UINT32 *)(a))[3] == htonl(1))
...
#define KDE_IN6_IS_ADDR_V4MAPPED(a) ((((Q_UINT32 *)(a))[0] == 0) && (((Q_UINT32 *)(a))[1] == 0) && (((Q_UINT32 *)(a))[2] == htonl(0xffff)))

#define KDE_IN6_IS_ADDR_V4COMPAT(a)                                                                                                                  \
    ((((Q_UINT32 *)(a))[0] == 0) && (((Q_UINT32 *)(a))[1] == 0) && (((Q_UINT32 *)(a))[2] == 0) && (ntohl(((Q_UINT32 *)(a))[3]) > 1))

#define KDE_IN6_ARE_ADDR_EQUAL(a, b)                                                                                                                 \
    ((((Q_UINT32 *)(a))[0] == ((Q_UINT32 *)(b))[0]) && (((Q_UINT32 *)(a))[1] == ((Q_UINT32 *)(b))[1])                                                \
     && (((Q_UINT32 *)(a))[2] == ((Q_UINT32 *)(b))[2]) && (((Q_UINT32 *)(a))[3] == ((Q_UINT32 *)(b))[3]))
...
extern KDECORE_EXPORT int kde_getaddrinfo(const char *name, const char *service, const struct addrinfo *hint, struct kde_addrinfo **result);
...
namespace KDE {
/** \internal */
extern KDECORE_EXPORT int getaddrinfo(const char *name, const char *service, const struct addrinfo *hint, struct addrinfo **result);
/** \internal */
extern KDECORE_EXPORT void freeaddrinfo(struct addrinfo *ai);
/** \internal */
extern KDECORE_EXPORT char *gai_strerror(int errorcode);
/** \internal */
extern KDECORE_EXPORT int getnameinfo(const struct sockaddr *sa, unsigned int salen, char *host, size_t hostlen, char *serv, size_t servlen,
                                      int flags);
}
