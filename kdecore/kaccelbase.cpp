...
KAccelBase::KAccelBase(int fInitCode) : m_rgActions(this)
{
...
bool KAccelBase::isEnabledInternal() const
{
    return isEnabled();
}
...
{
    kdDebug(125) << "KAccelBase::removeConnection( " << pAction << " = \"" << pAction->m_sName
                 << "\"; shortcut = " << pAction->m_cut.toStringInternal() << " ): this = " << this << endl;
