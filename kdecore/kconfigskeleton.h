...
public:
     ...
     */
    KConfigSkeletonItem(const QString &group, const QString &key) : mGroup(group), mKey(key), mIsImmutable(true)
    {
    }
...
public:
    KConfigSkeletonGenericItem(const QString &group, const QString &key, T &reference, T defaultValue)
        : KConfigSkeletonItem(group, key), mReference(reference), mDefault(defaultValue), mLoadedValue(defaultValue)
    {
    }
...
public:
    ...
    public:
        ...
        ItemString(const QString &group, const QString &key, QString &reference,
    ...
    public:
        ItemPassword(const QString &group, const QString &key, QString &reference,
                     const QString &defaultValue = QString::fromLatin1("")); // NOT QString::null !!
    };
    ...
    public:
        ItemPath(const QString &group, const QString &key, QString &reference, const QString &defaultValue = QString::null);
    };
    ...
    public:
        ItemStringList(const QString &group, const QString &key, QStringList &reference, const QStringList &defaultValue = QStringList());
    ...
    public:
        ItemIntList(const QString &group, const QString &key, QValueList< int > &reference,
...
public:
    ...
    */
     ...
     * @return The created item
     */
    ItemPassword *addItemPassword(const QString &name, QString &reference, const QString &defaultValue = QString::fromLatin1(""),
                                  const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemPath *addItemPath(const QString &name, QString &reference, const QString &defaultValue = QString::fromLatin1(""),
                          const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemProperty *addItemProperty(const QString &name, QVariant &reference, const QVariant &defaultValue = QVariant(),
                                  const QString &key = QString::null);
    /**
     ...
     * @return The created item
     */
    ItemColor *addItemColor(const QString &name, QColor &reference, const QColor &defaultValue = QColor(128, 128, 128),
                            const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemFont *addItemFont(const QString &name, QFont &reference, const QFont &defaultValue = KGlobalSettings::generalFont(),
                          const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemDateTime *addItemDateTime(const QString &name, QDateTime &reference, const QDateTime &defaultValue = QDateTime(),
                                  const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemStringList *addItemStringList(const QString &name, QStringList &reference, const QStringList &defaultValue = QStringList(),
                                      const QString &key = QString::null);
     ...
     * @return The created item
     */
    ItemIntList *addItemIntList(const QString &name, QValueList< int > &reference, const QValueList< int > &defaultValue = QValueList< int >(),
                                const QString &key = QString::null);
