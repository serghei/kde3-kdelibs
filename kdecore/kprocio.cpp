...
KProcIO::KProcIO(QTextCodec *_codec) : codec(_codec), d(new KProcIOPrivate)
{
    rbi = 0;
...
{
    connect(this, SIGNAL(receivedStdout(KProcess *, char *, int)), this, SLOT(received(KProcess *, char *, int)));

    if(includeStderr)
    {
        connect(this, SIGNAL(receivedStderr(KProcess *, char *, int)), this, SLOT(received(KProcess *, char *, int)));
    }

    connect(this, SIGNAL(wroteStdin(KProcess *)), this, SLOT(sent(KProcess *)));
