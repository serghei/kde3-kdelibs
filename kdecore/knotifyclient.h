 ...
 * @return a value > 0, unique for this event if successful, 0 otherwise
 */
KDECORE_EXPORT int userEvent(const QString &text = QString::null, int present = Default, int level = Default, const QString &sound = QString::null,
...
KDECORE_EXPORT int event(int winId, const QString &message, const QString &text = QString::null);
 ...
 */
// KDE4: use WId instead of int
KDECORE_EXPORT int event(int winId, StandardEvent event, const QString &text = QString::null);
