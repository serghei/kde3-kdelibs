...
KCalendarSystemHijri::KCalendarSystemHijri(const KLocale *locale) : KCalendarSystem(locale)
{
}
...
QString KCalendarSystemHijri::monthName(const QDate &date, bool shortName) const
{
    return monthName(month(date), year(date), shortName);
}

QString KCalendarSystemHijri::monthNamePossessive(const QDate &date, bool shortName) const
{
...
QString KCalendarSystemHijri::monthNamePossessive(int month, int year, bool shortName) const
{
    Q_UNUSED(year);
...
QString KCalendarSystemHijri::weekDayName(const QDate &date, bool shortName) const
{
