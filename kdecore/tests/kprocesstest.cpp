...
int main(int argc, char *argv[])
{
    ...
    p3 << "ls"
       << "-l";
    QObject::connect(&p3, SIGNAL(processExited(KProcess *)), &dummy, SLOT(printMessage(KProcess *)));

    QObject::connect(&p3, SIGNAL(receivedStdout(KProcess *, char *, int)), &dummy, SLOT(gotOutput(KProcess *, char *, int)));
    QObject::connect(&p3, SIGNAL(receivedStderr(KProcess *, char *, int)), &dummy, SLOT(gotOutput(KProcess *, char *, int)));
    ...
    p4 << "sort";
    QObject::connect(&p4, SIGNAL(processExited(KProcess *)), &dummy, SLOT(printMessage(KProcess *)));

    QObject::connect(&p4, SIGNAL(receivedStdout(KProcess *, char *, int)), &dummy, SLOT(gotOutput(KProcess *, char *, int)));
    QObject::connect(&p4, SIGNAL(receivedStderr(KProcess *, char *, int)), &dummy, SLOT(gotOutput(KProcess *, char *, int)));

    QObject::connect(&p4, SIGNAL(wroteStdin(KProcess *)), &dummy, SLOT(outputDone(KProcess *)));
