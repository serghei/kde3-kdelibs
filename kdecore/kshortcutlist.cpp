...
KAccelShortcutList::KAccelShortcutList(KAccel *pAccel) : m_actions(pAccel->actions())
{
...
KAccelShortcutList::KAccelShortcutList(KGlobalAccel *pAccel) : m_actions(pAccel->actions())
{
    d = new KAccelShortcutListPrivate;
    m_bGlobal = true;
    d->m_configGroup = pAccel->configGroup();
...
KAccelShortcutList::KAccelShortcutList(KAccelActions &actions, bool bGlobal) : m_actions(actions)
{
    d = new KAccelShortcutListPrivate;
    m_bGlobal = bGlobal;
}
