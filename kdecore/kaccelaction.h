...
protected:
    QString m_sName /**< Name of accel. @sa setName() */, m_sLabel /**< Label of accel. User-visible. */,
        m_sWhatsThis /**< WhatsThis help for accel. User-visible. */;
    KShortcut m_cut /**< Shortcut actually assigned. */;
    KShortcut m_cutDefault3 /**< Default shortcut in 3-modifier layout */, m_cutDefault4 /**< Default shortcur in 4-modifier layout */;
    const QObject *m_pObjSlot /**< Object we will send signals to. */;
    const char *m_psMethodSlot /**< Slot we send signals to, in m_pObjSlot */;
    bool m_bConfigurable /**< Can this accel be configured by the user? */, m_bEnabled /**< Is this accel enabled? */;
...
protected:
    ...
    uint m_nSizeAllocated /**< Allocated size of the array. */, m_nSize /**< Amount in use. */;
