...
static const char *const language_names[] = {I18N_NOOP("Other"),
                                             I18N_NOOP("Arabic"),
                                             I18N_NOOP("Baltic"),
...
static const char *const charsets_for_encoding[] = {
    "koi8-r", "koi8-u", "iso 8859-1", "iso 8859-2", "iso 8859-3", "iso 8859-4", "iso 8859-5", "iso 8859-6", "iso 8859-7", "iso 8859-8",
    "iso 8859-8-i", "iso 8859-9", "iso 8859-11", "iso 8859-13", "iso 8859-14", "iso 8859-15", "iso 8859-16", "utf8", "utf16", "iso-10646-ucs-2",
    "cp 1250", "cp 1251", "cp 1252", "cp 1253", "cp 1254", "cp 1255", "cp 1256", "cp 1257", "cp 1258", "ibm850", "ibm852", "ibm866", "tis620",
    "eucjp", "sjis", "jis7", "big5", "big5-hkscs", "gbk", "gb18030", "gb2312", "euckr", "tscii",
    //    "pt 154",
    "winsami2", "cp 874", 0}; // extra 0 for end
...
static struct LanguageForEncoding
{
    const char *index;
    int data;
} const language_for_encoding[] = {{"iso 8859-1", 13},
                                   {"iso 8859-15", 13},
                                   {"iso 8859-14", 13},
                                   {"cp 1252", 13},
                                   {"ibm850", 13},
...
static struct Builtin
{
    const char *index;
    const char *data;
} const builtin[] = {{"iso-ir-111", "koi8-r"},
...
template < typename T, typename Data > static Data kcharsets_array_search(const T *start, const char *entry)
{
    for(const T *pos = start; pos->index != 0; ++pos)
...
public:
    KCharsetsPrivate(KCharsets *_kc) : codecForNameDict(43, false) // case insensitive
    {
        db = 0;
        kc = _kc;
    }
...
{
    int lang = kcharsets_array_search< LanguageForEncoding, int >(language_for_encoding, encoding.latin1());
