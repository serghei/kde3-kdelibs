...
KCalendarSystemGregorian::KCalendarSystemGregorian(const KLocale *locale) : KCalendarSystem(locale)
{
}
...
QString KCalendarSystemGregorian::monthName(const QDate &date, bool shortName) const
{
...
QString KCalendarSystemGregorian::monthNamePossessive(int month, int year, bool shortName) const
{
    Q_UNUSED(year);
