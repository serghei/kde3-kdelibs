...
public:
     ...
     *         @p canReturnNull.
     */
    QPixmap loadIcon(const QString &name, KIcon::Group group, int size = 0, int state = KIcon::DefaultState, QString *path_store = 0L,
     ...
     * @since 3.5
     */
    QIconSet loadIconSet(const QString &name, KIcon::Group group, int size, bool canReturnNull, bool immediateExistenceCheck);
...
private:
     ...
     */
    QIconSet loadIconSetNonDelayed(const QString &name, KIcon::Group group, int size, bool canReturnNull);
 ...
 * Load a desktop icon.
 */
KDECORE_EXPORT QPixmap DesktopIcon(const QString &name, int size = 0, int state = KIcon::DefaultState, KInstance *instance = KGlobal::instance());
 ...
 */
KDECORE_EXPORT QIconSet DesktopIconSet(const QString &name, int size = 0, KInstance *instance = KGlobal::instance());

/**
 * \relates KIconLoader
 * Load a toolbar icon.
 */
KDECORE_EXPORT QPixmap BarIcon(const QString &name, int size = 0, int state = KIcon::DefaultState, KInstance *instance = KGlobal::instance());
 ...
 */
KDECORE_EXPORT QIconSet BarIconSet(const QString &name, int size = 0, KInstance *instance = KGlobal::instance());

/**
 * \relates KIconLoader
 * Load a small icon.
 */
KDECORE_EXPORT QPixmap SmallIcon(const QString &name, int size = 0, int state = KIcon::DefaultState, KInstance *instance = KGlobal::instance());
 ...
 */
KDECORE_EXPORT QIconSet SmallIconSet(const QString &name, int size = 0, KInstance *instance = KGlobal::instance());

/**
 * \relates KIconLoader
 * Load a main toolbar icon.
 */
KDECORE_EXPORT QPixmap MainBarIcon(const QString &name, int size = 0, int state = KIcon::DefaultState, KInstance *instance = KGlobal::instance());
 ...
 */
KDECORE_EXPORT QIconSet MainBarIconSet(const QString &name, int size = 0, KInstance *instance = KGlobal::instance());

/**
 * \relates KIconLoader
 * Load a user icon. User icons are searched in $appdir/pics.
 */
KDECORE_EXPORT QPixmap UserIcon(const QString &name, int state = KIcon::DefaultState, KInstance *instance = KGlobal::instance());
 ...
 */
KDECORE_EXPORT QIconSet UserIconSet(const QString &name, KInstance *instance = KGlobal::instance());
