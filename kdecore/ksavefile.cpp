...
KSaveFile::KSaveFile(const QString &filename, int mode) : mTempFile(true)
{
...
bool KSaveFile::backupFile(const QString &qFilename, const QString &backupDir, const QString &backupExtension)
{
