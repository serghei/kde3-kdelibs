...
KAudioPlayer::KAudioPlayer(const QString &filename, QObject *parent, const char *name) : QObject(parent, name)
{
...
{
    KNotifyClient::userEvent("KAudioPlayer event", KNotifyClient::Sound, KNotifyClient::Notification, d->filename);
}
