...
private:
     ...
     */
    QString translate_priv(const char *index, const char *text, const char **original = 0, int *pluralType = 0) const;
     ...
     *           if not found.
     */
    static QString catalogueFileName(const QString &language, const KCatalogue &catalog);
