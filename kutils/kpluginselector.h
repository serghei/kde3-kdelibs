...
public:
     ...
     *                     "kviewcanvas" ).
     */
    void addPlugins(const QString &instanceName, const QString &catname = QString::null, const QString &category = QString::null,
                    KConfig *config = 0);
     ...
     *                     "kviewcanvas" ).
     */
    void addPlugins(const QValueList< KPluginInfo * > &plugininfos, const QString &catname = QString::null, const QString &category = QString::null,
                    KConfig *config = 0);
...
private:
     ...
     * @internal
     */
    void addPluginsInternal(const QValueList< KPluginInfo * > plugininfos, const QString &catname, const QString &category, KConfigGroup *cfgGroup);
