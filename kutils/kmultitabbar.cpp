...
void KMultiTabBarInternal::drawContents(QPainter *paint, int clipx, int clipy, int clipw, int cliph)
{
    ...
    else if(m_position == KMultiTabBar::Left)
    {
    ...
    else if(m_position == KMultiTabBar::Bottom)
    {
        paint->setPen(colorGroup().shadow());
...
void KMultiTabBarInternal::resizeEvent(QResizeEvent *ev)
{
    ...
    else
    {
        ...
        if((m_position == KMultiTabBar::Bottom) || (m_position == KMultiTabBar::Top))
            ...
            box->setGeometry(0, 0, width(), size);
    }
}
...
KMultiTabBarButton::KMultiTabBarButton(const QPixmap &pic, const QString &text, QPopupMenu *popup, int id, QWidget *parent,
...
KMultiTabBarButton::KMultiTabBarButton(const QString &text, QPopupMenu *popup, int id, QWidget *parent, KMultiTabBar::KMultiTabBarPosition pos,
...
// calculate contents size...
    ...
    return (style().sizeFromContents(QStyle::CT_ToolButton, this, QSize(w, h)).expandedTo(QApplication::globalStrut()));
}


KMultiTabBarTab::KMultiTabBarTab(const QPixmap &pic, const QString &text, int id, QWidget *parent, KMultiTabBar::KMultiTabBarPosition pos,
                                 KMultiTabBar::KMultiTabBarStyle style)
    : KMultiTabBarButton(text, 0, id, parent, pos, style), m_showActiveTabText(false)
{
...
void KMultiTabBarTab::drawButtonClassic(QPainter *paint)
{
    ...
    if(!isOn())
    {
        ...
        else if((m_position == KMultiTabBar::Bottom) || (m_position == KMultiTabBar::Top))
        {
    ...
    else
    {
        ...
        else if(m_position == KMultiTabBar::Top)
        {
...
int KMultiTabBar::appendButton(const QPixmap &pic, int id, QPopupMenu *popup, const QString &)
{
    ...
    m_buttons.append(btn = new KMultiTabBarButton(pic, QString::null, popup, id, this, m_position, m_internal->m_style));
