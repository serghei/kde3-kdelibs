...
KPixmapSplitter::KPixmapSplitter() : m_itemSize(4, 7), m_vSpacing(0), m_hSpacing(0), m_numCols(0), m_numRows(0), m_dirty(false)
{
}
...
QRect KPixmapSplitter::coordinates(int pos)
{
    ...
    return QRect(col * (m_itemSize.width() + m_hSpacing), row * (m_itemSize.height() + m_vSpacing), m_itemSize.width(), m_itemSize.height());
}
