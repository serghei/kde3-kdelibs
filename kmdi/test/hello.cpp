/****************************************************************************
** $Id: hello.cpp 369568 2004-12-10 04:36:02Z mattr $
**
...
Hello::Hello(const char *title, const char *text, QWidget *parentWidget) : KMdiChildView(title, parentWidget), t(text), b(0)
{
...
{
    static int sin_tbl[16] = {0, 38, 71, 92, 100, 92, 71, 38, 0, -38, -71, -92, -100, -92, -71, -38};
