...
private:
    ...
    // methods
public:
    KMdiMainFrm(QWidget *parentWidget, const char *name = "", KMdi::MdiMode mdiMode = KMdi::ChildframeMode,
    ...
    {
        m_undockPositioningOffset = offset;
    }
...
public slots:
     ...
     */
    virtual KMdiToolViewAccessor *addToolWindow(QWidget *pWnd, KDockWidget::DockPosition pos = KDockWidget::DockNone, QWidget *pTargetWnd = 0L,
...
protected:
    ...
    {
        m_bClearingOfWindowMenuBlocked = bBlocked;
    }
