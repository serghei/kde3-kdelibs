...
public:
    NamespaceTest();
    k_dcop : void function1(QString filename, QString url, QString text, QString address, QString icon);
};
}
...
public:
    ...
    k_dcop_signals : void signal1(QString filename, QString url, QString text, QString address, QString icon);
