 ...
 * blah di blah
 **/
class KDEUI_EXPORT Test : public MyNamespace::MyParentClass, virtual public DCOPObject, public QValueList< QString > {
    K_DCOP
...
public:
    ...
    k_dcop_signals : void blah_signal();
...
class Test2 : public DCOPObject {
    K_DCOP
public:
    k_dcop_signals : void fooSignal(int arg);
};
