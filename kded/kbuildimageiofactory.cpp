...
KBuildImageIOFactory::KBuildImageIOFactory() : KImageIOFactory()
{
...
KSycocaEntry *KBuildImageIOFactory::createEntry(const QString &file, const char *resource)
{
...
void KBuildImageIOFactory::addEntry(KSycocaEntry *newEntry, const char *resource)
{
...
void KBuildImageIOFactory::saveHeader(QDataStream &str)
{
...
void KBuildImageIOFactory::save(QDataStream &str)
{
    rPath.sort();
    // Remove duplicates from rPath:
    QString last;
    for(QStringList::Iterator it = rPath.begin(); it != rPath.end();)
    {
