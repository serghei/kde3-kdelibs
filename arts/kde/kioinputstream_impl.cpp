...
void KIOInputStream_impl::streamStart()
{
    ...
    QObject::connect(m_job, SIGNAL(data(KIO::Job *, const QByteArray &)), this, SLOT(slotData(KIO::Job *, const QByteArray &)));
    QObject::connect(m_job, SIGNAL(result(KIO::Job *)), this, SLOT(slotResult(KIO::Job *)));
    QObject::connect(m_job, SIGNAL(mimetype(KIO::Job *, const QString &)), this, SLOT(slotScanMimeType(KIO::Job *, const QString &)));
    QObject::connect(m_job, SIGNAL(totalSize(KIO::Job *, KIO::filesize_t)), this, SLOT(slotTotalSize(KIO::Job *, KIO::filesize_t)));
...
void KIOInputStream_impl::streamEnd()
{
    ...
    if(m_job != 0)
    {
        QObject::disconnect(m_job, SIGNAL(data(KIO::Job *, const QByteArray &)), this, SLOT(slotData(KIO::Job *, const QByteArray &)));
        QObject::disconnect(m_job, SIGNAL(result(KIO::Job *)), this, SLOT(slotResult(KIO::Job *)));
        QObject::disconnect(m_job, SIGNAL(mimetype(KIO::Job *, const QString &)), this, SLOT(slotScanMimeType(KIO::Job *, const QString &)));
        QObject::disconnect(m_job, SIGNAL(totalSize(KIO::Job *, KIO::filesize_t)), this, SLOT(slotTotalSize(KIO::Job *, KIO::filesize_t)));
...
void KIOInputStream_impl::processQueue()
{
    ...
    if(!m_firstBuffer)
    {
        ...
        {
            kdDebug(400) << "STREAMING: Buffering in progress... (Needed bytes before it starts to play: "
                         << ((m_packetBuffer * m_packetSize * 2) - m_data.size()) << ")" << endl;
            return;
        }
        else
        {
