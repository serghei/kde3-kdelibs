...
namespace Arts {
class SoundServerV2_impl : virtual public SoundServerV2_skel, public SoundServer_impl {
protected:
    SampleStorage _sampleStorage;

    void rebuildTraderCache(const std::string &directory, std::vector< TraderOffer > *offers);
