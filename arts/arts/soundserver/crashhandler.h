...
public:
     ...
     * @param name the name of the application, as shown in Dr. Konqi
     */
    static void setApplicationVersion(const std::string &name)
    {
        appVersion = strdup(name.c_str());
    }
     ...
     * @param name the name of the application, as shown in Dr. Konqi
     */
    static void setBugAddress(const std::string &name)
    {
        bugAddress = strdup(name.c_str());
    }
     ...
     */
    static void setCrashApp(const std::string &app)
    {
        crashApp = strdup(app.c_str());
    }
