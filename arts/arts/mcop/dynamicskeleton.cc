...
public:
    DynamicSkeletonData(DynamicSkeletonBase *base, Object_skel *skel, const string &interfaceName, const string &interfaceNameParent)
        : base(base), skel(skel), interfaceName(interfaceName), interfaceNameParent(interfaceNameParent)
    {
    }
...
DynamicSkeletonBase::DynamicSkeletonBase(Object_skel *skel, const std::string &interfaceName, const std::string &interfaceNameParent)
{
    arts_assert(skel != 0);
...
void DynamicSkeletonBase::_dsInit(Object_skel *skel, const std::string &interfaceName, const std::string &interfaceNameParent)
{
