...
public:
     ...
     */
    static std::string readConfigEntry(const std::string &key, const std::string &defaultValue = "");
     ...
     * and the values.
     */
    static bool tokenize(const std::string &line, std::string &key, std::vector< std::string > &values);
};
}
#endif /* MCOPUTILS_H */
