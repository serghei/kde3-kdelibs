...
#define arts_return_if_fail(expr)                                                                                                                    \
    ...
    {                                                                                                                                                \
        if(!(expr))                                                                                                                                  \
        {                                                                                                                                            \
            arts_warning("file %s: line %d (%s): assertion failed: (%s)", __FILE__, __LINE__, __PRETTY_FUNCTION__, #expr);                           \
            return;                                                                                                                                  \
        }                                                                                                                                            \
    } while(0)
...
#define arts_assert(expr)                                                                                                                            \
    ...
    {                                                                                                                                                \
        if(!(expr))                                                                                                                                  \
            arts_fatal("file %s: line %d (%s): assertion failed: (%s)", __FILE__, __LINE__, __PRETTY_FUNCTION__, #expr);                             \
    } while(0)
...
#define arts_return_if_fail(expr)                                                                                                                    \
    ...
    {                                                                                                                                                \
        if(!(expr))                                                                                                                                  \
        {                                                                                                                                            \
            arts_warning("file %s: line %d: assertion failed: (%s)", __FILE__, __LINE__, #expr);                                                     \
            return;                                                                                                                                  \
        }                                                                                                                                            \
    } while(0)
...
#define arts_assert(expr)                                                                                                                            \
    ...
    {                                                                                                                                                \
        if(!(expr))                                                                                                                                  \
            arts_fatal("file %s: line %d: assertion failed: (%s)", __FILE__, __LINE__, #expr);                                                       \
    } while(0)
