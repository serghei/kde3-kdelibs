...
public:
    ...
    inline const ObjectReference &reference() const
    {
        return myref;
    }
};
...
public:
    ...
    inline SubClass &operator=(const std::string &s)
    {
        mys = s;
        return *this;
    }
    inline SubClass &operator=(const char *c)
    {
        mys = c;
        return *this;
    }
...
protected:
    ...
    public:
        Object_base *base;
        inline Pool(Object_base *b) : creator(0), created(true), count(1), base(b)
        {
        }
        inline Pool(Object_base *(*cor)()) : creator(cor), created(false), count(1), base(0)
        {
        }
        inline void Inc()
        {
...
public:
    ...
    */
    ...
    inline static Object null()
    {
        return Object((Object_base *)0);
    }
    inline static Object _from_base(Object_base *b)
    {
        return Object(b);
    }
};
