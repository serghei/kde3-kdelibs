...
Arts::ServerHello::ServerHello(const std::string &_a_mcopVersion, const std::string &_a_serverID, const std::vector< std::string > &_a_authProtocols,
...
Arts::MethodDef::MethodDef(const std::string &_a_name, const std::string &_a_type, Arts::MethodType _a_flags,
                           const std::vector< Arts::ParamDef > &_a_signature, const std::vector< std::string > &_a_hints)
{
    this->name = _a_name;
    this->type = _a_type;
    this->flags = _a_flags;
...
Arts::AttributeDef::AttributeDef(const std::string &_a_name, const std::string &_a_type, Arts::AttributeType _a_flags,
...
Arts::InterfaceDef::InterfaceDef(const std::string &_a_name, const std::vector< std::string > &_a_inheritedInterfaces,
...
Arts::ModuleDef::ModuleDef(const std::string &_a_moduleName, const std::vector< Arts::EnumDef > &_a_enums,
                           const std::vector< Arts::TypeDef > &_a_types, const std::vector< Arts::InterfaceDef > &_a_interfaces,
                           const std::vector< std::string > &_a_hints)
{
...
{
    if(iid == Arts::InterfaceRepo_base::_IID)
        return (Arts::InterfaceRepo_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::InterfaceRepo_stub::InterfaceRepo_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
...
long Arts::InterfaceRepo_stub::insertModule(const Arts::ModuleDef &newModule)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000d696e736572744d6f64756c6500000000056c6f6e6700000000020000000100000010417274733a3a4d6f64756c65446566000000000a6e65774d6f64756c65000000"
        "000000000000");
    long requestID;
...
{
    long methodID = _lookupMethodFast(
        "method:0000000d72656d6f76654d6f64756c650000000005766f6964000000000200000001000000056c6f6e6700000000096d6f64756c654944000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
Arts::InterfaceDef Arts::InterfaceRepo_stub::queryInterface(const std::string &name)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000f7175657279496e746572666163650000000013417274733a3a496e7465726661636544656600000000020000000100000007737472696e6700000000056e616d6500"
        "0000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return Arts::InterfaceDef(); // error occurred
...
Arts::TypeDef Arts::InterfaceRepo_stub::queryType(const std::string &name)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000a717565727954797065000000000e417274733a3a5479706544656600000000020000000100000007737472696e6700000000056e616d65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(name);
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return Arts::TypeDef(); // error occurred
...
Arts::EnumDef Arts::InterfaceRepo_stub::queryEnum(const std::string &name)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000a7175657279456e756d000000000e417274733a3a456e756d44656600000000020000000100000007737472696e6700000000056e616d65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(name);
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return Arts::EnumDef(); // error occurred
...
std::vector< std::string > *Arts::InterfaceRepo_stub::queryChildren(const std::string &name)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000e71756572794368696c6472656e00000000082a737472696e6700000000020000000100000007737472696e6700000000056e616d65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(name);
...
{
    if(interfacename == "Arts::InterfaceRepo")
        return true;
...
{
    if(iid == Arts::InterfaceRepoV2_base::_IID)
        return (Arts::InterfaceRepoV2_base *)this;
    if(iid == Arts::InterfaceRepo_base::_IID)
        return (Arts::InterfaceRepo_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
...
Arts::InterfaceRepoV2_stub::InterfaceRepoV2_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
Arts::TypeIdentification Arts::InterfaceRepoV2_stub::identifyType(const std::string &name)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000d6964656e74696679547970650000000019417274733a3a547970654964656e74696669636174696f6e00000000020000000100000007737472696e6700000000056e"
        "616d65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(name);
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return (Arts::TypeIdentification)0; // error occurred
...
{
    if(interfacename == "Arts::InterfaceRepoV2")
        return true;
    if(interfacename == "Arts::InterfaceRepo")
        return true;
    if(interfacename == "Arts::Object")
...
{
    if(iid == Arts::FlowSystemSender_base::_IID)
        return (Arts::FlowSystemSender_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::FlowSystemSender_stub::FlowSystemSender_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
{
    if(interfacename == "Arts::FlowSystemSender")
        return true;
    if(interfacename == "Arts::Object")
        return true;
    return false;
...
{
    if(iid == Arts::FlowSystemReceiver_base::_IID)
        return (Arts::FlowSystemReceiver_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::FlowSystemReceiver_stub::FlowSystemReceiver_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
{
    if(interfacename == "Arts::FlowSystemReceiver")
        return true;
    if(interfacename == "Arts::Object")
        return true;
    return false;
...
{
    if(iid == Arts::FlowSystem_base::_IID)
        return (Arts::FlowSystem_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::FlowSystem_stub::FlowSystem_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
{
    long methodID = _lookupMethodFast(
        "method:0000000c73746172744f626a6563740000000005766f6964000000000200000001000000076f626a65637400000000056e6f6465000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
{
    long methodID = _lookupMethodFast(
        "method:0000000b73746f704f626a6563740000000005766f6964000000000200000001000000076f626a65637400000000056e6f6465000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    Arts::writeObject(*request, node._base());
...
void Arts::FlowSystem_stub::connectObject(Arts::Object sourceObject, const std::string &sourcePort, Arts::Object destObject,
                                          const std::string &destPort)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000e636f6e6e6563744f626a6563740000000005766f6964000000000200000004000000076f626a656374000000000d736f757263654f626a6563740000000000000000"
        "07737472696e67000000000b736f75726365506f72740000000000000000076f626a656374000000000b646573744f626a656374000000000000000007737472696e67000000"
        "000964657374506f7274000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
void Arts::FlowSystem_stub::disconnectObject(Arts::Object sourceObject, const std::string &sourcePort, Arts::Object destObject,
                                             const std::string &destPort)
{
    long methodID = _lookupMethodFast(
        "method:"
        "00000011646973636f6e6e6563744f626a6563740000000005766f6964000000000200000004000000076f626a656374000000000d736f757263654f626a6563740000000000"
        "00000007737472696e67000000000b736f75726365506f72740000000000000000076f626a656374000000000b646573744f626a656374000000000000000007737472696e67"
        "000000000964657374506f7274000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    Arts::writeObject(*request, sourceObject._base());
...
Arts::AttributeType Arts::FlowSystem_stub::queryFlags(Arts::Object node, const std::string &port)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000b7175657279466c6167730000000014417274733a3a41747472696275746554797065000000000200000002000000076f626a65637400000000056e6f646500000000"
        "0000000007737472696e670000000005706f7274000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    Arts::writeObject(*request, node._base());
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return (Arts::AttributeType)0; // error occurred
...
void Arts::FlowSystem_stub::setFloatValue(Arts::Object node, const std::string &port, float value)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000e736574466c6f617456616c75650000000005766f6964000000000200000003000000076f626a65637400000000056e6f6465000000000000000007737472696e6700"
        "00000005706f7274000000000000000006666c6f6174000000000676616c7565000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    Arts::writeObject(*request, node._base());
...
Arts::FlowSystemReceiver Arts::FlowSystem_stub::createReceiver(Arts::Object destObject, const std::string &destPort, Arts::FlowSystemSender sender)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000f63726561746552656365697665720000000019417274733a3a466c6f7753797374656d5265636569766572000000000200000003000000076f626a65637400000000"
        "0b646573744f626a656374000000000000000007737472696e67000000000964657374506f7274000000000000000017417274733a3a466c6f7753797374656d53656e646572"
        "000000000773656e646572000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    Arts::writeObject(*request, destObject._base());
    ...
    result = Arts::Dispatcher::the()->waitForResult(requestID, _connection);
    if(!result)
        return Arts::FlowSystemReceiver::null();
...
{
    if(interfacename == "Arts::FlowSystem")
        return true;
    if(interfacename == "Arts::Object")
        return true;
    return false;
...
{
    if(iid == Arts::GlobalComm_base::_IID)
        return (Arts::GlobalComm_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::GlobalComm_stub::GlobalComm_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
bool Arts::GlobalComm_stub::put(const std::string &variable, const std::string &value)
{
    long methodID = _lookupMethodFast(
        "method:"
        "000000047075740000000008626f6f6c65616e00000000020000000200000007737472696e6700000000097661726961626c65000000000000000007737472696e6700000000"
        "0676616c7565000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
{
    long methodID = _lookupMethodFast(
        "method:000000046765740000000007737472696e6700000000020000000100000007737472696e6700000000097661726961626c65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(variable);
...
{
    long methodID = _lookupMethodFast(
        "method:0000000665726173650000000005766f696400000000020000000100000007737472696e6700000000097661726961626c65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(variable);
...
{
    if(interfacename == "Arts::GlobalComm")
        return true;
    if(interfacename == "Arts::Object")
        return true;
    return false;
...
{
    if(iid == Arts::TmpGlobalComm_base::_IID)
        return (Arts::TmpGlobalComm_base *)this;
    if(iid == Arts::GlobalComm_base::_IID)
        return (Arts::GlobalComm_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
...
Arts::TmpGlobalComm_stub::TmpGlobalComm_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
{
    if(interfacename == "Arts::TmpGlobalComm")
        return true;
    if(interfacename == "Arts::GlobalComm")
        return true;
    if(interfacename == "Arts::Object")
...
{
    if(iid == Arts::TraderOffer_base::_IID)
        return (Arts::TraderOffer_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::TraderOffer_stub::TraderOffer_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
{
    long methodID = _lookupMethodFast(
        "method:0000000c67657450726f706572747900000000082a737472696e6700000000020000000100000007737472696e6700000000056e616d65000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->writeString(name);
...
{
    if(iid == Arts::TraderQuery_base::_IID)
        return (Arts::TraderQuery_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::TraderQuery_stub::TraderQuery_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
void Arts::TraderQuery_stub::supports(const std::string &property, const std::string &value)
{
    long methodID = _lookupMethodFast(
        "method:"
        "00000009737570706f7274730000000005766f696400000000020000000200000007737472696e67000000000970726f7065727479000000000000000007737472696e670000"
        "00000676616c7565000000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
{
    if(interfacename == "Arts::TraderQuery")
        return true;
    if(interfacename == "Arts::Object")
        return true;
    return false;
...
{
    if(iid == Arts::Loader_base::_IID)
        return (Arts::Loader_base *)this;
    if(iid == Arts::Object_base::_IID)
        return (Arts::Object_base *)this;
    return 0;
}
...
Arts::Loader_stub::Loader_stub(Arts::Connection *connection, long objectID) : Arts::Object_stub(connection, objectID)
{
    // constructor to create a stub for an object
}
...
Arts::Object Arts::Loader_stub::loadObject(Arts::TraderOffer offer)
{
    long methodID = _lookupMethodFast(
        "method:"
        "0000000b6c6f61644f626a65637400000000076f626a65637400000000020000000100000012417274733a3a5472616465724f6666657200000000066f666665720000000000"
        "00000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
...
{
    long methodID = _lookupMethodFast(
        "method:000000135f6765745f747261646572456e747269657300000000132a417274733a3a547261646572456e74727900000000020000000000000000");
    long requestID;
    Arts::Buffer *request, *result;
    request = Arts::Dispatcher::the()->createRequest(requestID, _objectID, methodID);
    request->patchLength();
