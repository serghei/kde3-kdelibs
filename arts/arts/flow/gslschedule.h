...
public:
    Port(const std::string &name, void *ptr, long flags, StdScheduleNode *parent);
    virtual ~Port();
...
public:
    ...
    AudioPort(const std::string &name, void *ptr, long flags, StdScheduleNode *parent);
    ~AudioPort();
...
public:
    MultiPort(const std::string &name, void *ptr, long flags, StdScheduleNode *parent);
    ~MultiPort();
...
public:
    ...
    void stop();
    void requireFlow();
    void virtualize(const std::string &port, ScheduleNode *implNode, const std::string &implPort);
    void devirtualize(const std::string &port, ScheduleNode *implNode, const std::string &implPort);
    ...
    void connect(const std::string &port, ScheduleNode *dest, const std::string &destport);
    void disconnect(const std::string &port, ScheduleNode *dest, const std::string &destport);
