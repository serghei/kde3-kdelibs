...
class ASyncNetReceive : public FlowSystemReceiver_skel, public GenericDataChannel {
protected:
...
public:
    ...
    // Port interface
    ASyncPort(const std::string &name, void *ptr, long flags, StdScheduleNode *parent);
    ~ASyncPort();
