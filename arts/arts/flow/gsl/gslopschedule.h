...
void _engine_schedule_node(EngineSchedule *schedule, EngineNode *node, guint leaf_level);
void _engine_schedule_cycle(EngineSchedule *schedule, GslRing *cycle_nodes, guint leaf_level);
