...
{
    GslErrorType (*open)(GslDataHandle *data_handle, GslDataHandleSetup *setup);
    GslLong (*read)(GslDataHandle *data_handle, GslLong voffset, /* in values */
                    GslLong n_values, gfloat *values);
    void (*close)(GslDataHandle *data_handle);
    void (*destroy)(GslDataHandle *data_handle);
    /* optional (for codecs) */
    GslLong (*coarse_seek)(GslDataHandle *data_handle, GslLong position);
};
...
#define gsl_data_handle_n_values(dh) gsl_data_handle_length(dh)
...
GslLong gsl_data_handle_read(GslDataHandle *data_handle, GslLong value_offset, GslLong n_values, gfloat *values);
...
{ GSL_WAVE_FORMAT_NONE,
  ...
  GSL_WAVE_FORMAT_LAST } GslWaveFormatType;
