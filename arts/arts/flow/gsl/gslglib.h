...
#define GSL_ASSERT(foo)                                                                                                                              \
    do                                                                                                                                               \
    {                                                                                                                                                \
        if(!(foo))                                                                                                                                   \
            g_error("assertion failed `%s'", #foo);                                                                                                  \
    } while(0)
...
#define GUINT16_SWAP_LE_BE(val) ((guint16)((((guint16)(val) & (guint16)0x00ffU) << 8) | (((guint16)(val) & (guint16)0xff00U) >> 8)))
...
#define g_return_if_fail(foo)                                                                                                                        \
    do                                                                                                                                               \
    {                                                                                                                                                \
        if(!(foo))                                                                                                                                   \
            g_message(G_STRLOC ": assertion failed `%s'", #foo);                                                                                     \
    } while(0)
#define g_return_val_if_fail(foo, v)                                                                                                                 \
    do                                                                                                                                               \
    {                                                                                                                                                \
        if(!(foo))                                                                                                                                   \
        {                                                                                                                                            \
...
static inline void g_print(const gchar *format, ...)
{
    va_list args;
    va_start(args, format);
...
static inline void g_printerr(const gchar *format, ...)
{
    va_list args;
    va_start(args, format);
...
#define G_GNUC_NO_INSTRUMENT __attribute__((no_instrument_function))
#else /* !__GNUC__ */
...
gchar *g_convert(const gchar *str, gsize len,                                                                                /* gssize */
