...
/* --- windows --- */
double gsl_window_bartlett(double x) /* triangle */
{
    if(fabs(x) > 1)
        return 0;
...
double gsl_window_cos(double x) /* von Hann window */
{
    if(fabs(x) > 1)
        return 0;
...
double gsl_window_hamming(double x) /* sharp (rectangle) cutoffs at boundaries */
{
    if(fabs(x) > 1)
        return 0;
...
double gsl_window_sinc(double x) /* noramlied C. Lanczos window */
{
    if(fabs(x) > 1)
        return 0;
    x = x * GSL_PI;
...
double gsl_window_rect(double x) /* a square */
{
    if(fabs(x) > 1)
        return 0;
    return 1.0;
...
#define GSL_2_RAISED_TO_1_OVER_1200_d                                                                                                                \
    (/* 2^(1/1200) */                                                                                                                                \
