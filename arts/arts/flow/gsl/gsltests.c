...
static const gchar *pshift(void)
{
...
restart:
    ...
    else if(strcmp(arg, "snc") == 0)
    {
        ...
        g_print("snc(%s, %s) = %s\n", gsl_complex_str(u), gsl_complex_str(emmc), gsl_complex_str(gsl_complex_ellip_sn(u, emmc)));
    }
    else if(strcmp(arg, "sci_snc") == 0)
    {
        ...
        g_print("sci_snc(%s, %s) = %s\n", gsl_complex_str(u), gsl_complex_str(k2),
    ...
    else if(strcmp(arg, "asnc") == 0)
    {
        ...
        g_print("asnc(%s, %s) = %s\n", gsl_complex_str(y), gsl_complex_str(emmc), gsl_complex_str(gsl_complex_ellip_asn(y, emmc)));
    ...
    else if(strcmp(arg, "sin") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("sin(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_sin(phi)));
    }
    else if(strcmp(arg, "cos") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("cos(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_cos(phi)));
    }
    else if(strcmp(arg, "tan") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("tan(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_tan(phi)));
    }
    else if(strcmp(arg, "sinh") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("sinh(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_sinh(phi)));
    }
    else if(strcmp(arg, "cosh") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("cosh(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_cosh(phi)));
    }
    else if(strcmp(arg, "tanh") == 0)
    {
        ...
        phi.re = atof(pshift());
        phi.im = atof(pshift());
        g_print("tanh(%s) = %s\n", gsl_complex_str(phi), gsl_complex_str(gsl_complex_tanh(phi)));
    }
    ...
    else if(strcmp(arg, "t2h") == 0)
    {
        ...
        g_print("# Highpass Tschebyscheff Type2 order=%u freq=%f steepness=%f (%f, %f) epsilon(s^2)=%f norm=%f:\n", order, f, st, GSL_PI - f,
                (GSL_PI - f) * (1. + st), e, gsl_poly_eval(order, a, 1) / gsl_poly_eval(order, b, 1));
        filter_label = "T2H";
    }
    ...
    else if(strncmp(arg, "poly", 4) == 0)
    {
        ...
        order = 2;
        {
            ...
            g_print("# Test order=%u  norm=%f:\n", order, gsl_poly_eval(order, a, 1) / gsl_poly_eval(order, b, 1));
            g_print("H%u(z)=%s/%s\n", order, gsl_poly_str(order, a, "z"), gsl_poly_str(order, b, "z"));
            if(*arg)
            {
    ...
    if(a && b)
    {
        ...
        {
            g_print("%s%u(z)=%s/%s\n", filter_label, order, gsl_poly_str(order, a, "z"), gsl_poly_str(order, b, "z"));
        }
        else
