...
/* --- common utilities --- */
static inline double cotan(double x)
{
    return -tan(x + GSL_PI * 0.5);
}

static double gsl_db_invert(double x)
{
    /* db = 20*log(x)/log(10); */
    return exp(x * log(10) / 20.0);
}

static void band_filter_common(unsigned int iorder, double p_freq,                              /* 0..pi */
                               double s_freq,                                                   /* 0..pi */
                               double epsilon, GslComplex *roots, GslComplex *poles, double *a, /* [0..iorder] */
                               double *b, gboolean band_pass, gboolean t1_norm)
{
    unsigned int iorder2 = iorder >> 1;
    GslComplex *poly = g_newa(GslComplex, iorder + 1);
    GslComplex fpoly[2 + 1] = {{
                                   0,
                               },
                               {
                                   0,
...
static void filter_rp_to_z(unsigned int iorder, GslComplex *roots, /* [0..iorder-1] */
                           GslComplex *poles, double *a,           /* [0..iorder] */
                           double *b)
{
    GslComplex *poly = g_newa(GslComplex, iorder + 1);
    guint i;
...
static void filter_lp_invert(unsigned int iorder, double *a, /* [0..iorder] */
                             double *b)
{
    guint i;
...
/* --- butterworth filter --- */
void gsl_filter_butter_rp(unsigned int iorder, double freq,  /* 0..pi */
                          double epsilon, GslComplex *roots, /* [0..iorder-1] */
                          GslComplex *poles)
{
...
static double tschebyscheff_eval(unsigned int degree, double x)
{
...
static double tschebyscheff_inverse(unsigned int degree, double x)
{
    /* note, that thebyscheff_eval(degree,x)=cosh(degree*acosh(x)) */
    return cosh(acosh(x) / degree);
}

void gsl_filter_tscheb1_rp(unsigned int iorder, double freq,  /* 1..pi */
                           double epsilon, GslComplex *roots, /* [0..iorder-1] */
                           GslComplex *poles)
{
    double pi = GSL_PI, order = iorder;
...
void gsl_filter_tscheb2_rp(unsigned int iorder, double c_freq,                  /* 1..pi */
                           double steepness, double epsilon, GslComplex *roots, /* [0..iorder-1] */
                           GslComplex *poles)
{
    double pi = GSL_PI, order = iorder;
 ...
 */
double gsl_filter_tscheb2_steepness_db(unsigned int iorder, double c_freq, double epsilon, double stopband_db)
{
 ...
 */
double gsl_filter_tscheb2_steepness(unsigned int iorder, double c_freq, double epsilon, double residue)
{
 ...
 */
void gsl_filter_butter_lp(unsigned int iorder, double freq, /* 0..pi */
                          double epsilon, double *a,        /* [0..iorder] */
                          double *b)
{
 ...
 */
void gsl_filter_tscheb1_lp(unsigned int iorder, double freq, /* 0..pi */
                           double epsilon, double *a,        /* [0..iorder] */
                           double *b)
{
    GslComplex *roots = g_newa(GslComplex, iorder);
 ...
 */
void gsl_filter_tscheb2_lp(unsigned int iorder, double freq,            /* 0..pi */
                           double steepness, double epsilon, double *a, /* [0..iorder] */
                           double *b)
{
    GslComplex *roots = g_newa(GslComplex, iorder);
    GslComplex *poles = g_newa(GslComplex, iorder);
 ...
 */
void gsl_filter_butter_hp(unsigned int iorder, double freq, /* 0..pi */
                          double epsilon, double *a,        /* [0..iorder] */
                          double *b)
{
    g_return_if_fail(freq > 0 && freq < GSL_PI);
 ...
 */
void gsl_filter_tscheb1_hp(unsigned int iorder, double freq, /* 0..pi */
                           double epsilon, double *a,        /* [0..iorder] */
                           double *b)
{
    g_return_if_fail(freq > 0 && freq < GSL_PI);
 ...
 */
void gsl_filter_tscheb2_hp(unsigned int iorder, double freq, double steepness, double epsilon, double *a, /* [0..iorder] */
                           double *b)
{
    g_return_if_fail(freq > 0 && freq < GSL_PI);
 ...
 */
void gsl_filter_butter_bp(unsigned int iorder, double freq1, /* 0..pi */
                          double freq2,                      /* 0..pi */
                          double epsilon, double *a,         /* [0..iorder] */
                          double *b)
{
 ...
 */
void gsl_filter_tscheb1_bp(unsigned int iorder, double freq1, /* 0..pi */
                           double freq2,                      /* 0..pi */
                           double epsilon, double *a,         /* [0..iorder] */
                           double *b)
{
 ...
 */
void gsl_filter_tscheb2_bp(unsigned int iorder, double freq1,           /* 0..pi */
                           double freq2,                                /* 0..pi */
                           double steepness, double epsilon, double *a, /* [0..iorder] */
                           double *b)
{
 ...
 */
void gsl_filter_butter_bs(unsigned int iorder, double freq1, /* 0..pi */
                          double freq2,                      /* 0..pi */
                          double epsilon, double *a,         /* [0..iorder] */
                          double *b)
{
 ...
 */
void gsl_filter_tscheb1_bs(unsigned int iorder, double freq1, /* 0..pi */
                           double freq2,                      /* 0..pi */
                           double epsilon, double *a,         /* [0..iorder] */
                           double *b)
{
 ...
 */
void gsl_filter_tscheb2_bs(unsigned int iorder, double freq1,           /* 0..pi */
                           double freq2,                                /* 0..pi */
                           double steepness, double epsilon, double *a, /* [0..iorder] */
                           double *b)
{
...
static inline double gsl_blackman_window(double x)
{
    if(x < 0)
        return 0;
    if(x > 1)
 ...
 * @n_points >= @iorder.
 */
void gsl_filter_fir_approx(unsigned int iorder, double *a, /* [0..iorder] */
                           unsigned int n_points, const double *freq, const double *value)
{
    /* TODO:
     *
...
/* --- filter evaluation --- */
void gsl_iir_filter_setup(GslIIRFilter *f, guint order, const gdouble *a, const gdouble *b, gdouble *buffer) /* 4*(order+1) */
{
    guint i;
...
static inline gdouble /* Y */
    filter_step_direct_canon_2(GslIIRFilter *f, gdouble X)
{
...
static inline gdouble /* Y */
    filter_step_direct_canon_1(GslIIRFilter *f, gdouble X)
{
    register guint n = f->order;
    gdouble *a = f->a, *b = f->b, *w = f->w;
    gdouble y, v;
...
static void biquad_lpreso(GslBiquadConfig *c, GslBiquadFilter *f)
{
 ...
 */
gdouble gsl_filter_sine_scan(guint order, const gdouble *a, const gdouble *b, gdouble freq, guint n_values)
{
