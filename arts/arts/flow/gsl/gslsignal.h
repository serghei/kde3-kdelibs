...
void gsl_frequency_modulator(const GslFrequencyModulator *fm, guint n_values, const gfloat *ifreq, const gfloat *ifmod, gfloat *fm_buffer);
...
static inline double G_GNUC_CONST gsl_approx_atan1(register double x)
{
...
static inline double G_GNUC_CONST gsl_approx_qcircle1(register double x)
{
...
static inline double G_GNUC_CONST gsl_approx_qcircle2(register double x)
{
...
static inline double G_GNUC_CONST gsl_approx_qcircle3(register double x)
{
...
static inline double G_GNUC_CONST gsl_approx_qcircle4(register double x)
{
...
static inline double G_GNUC_CONST gsl_approx_exp2(float ex)
{
    register GslFloatIEEE754 fp = {
        0,
    };
...
static inline float G_GNUC_CONST _gsl_signal_exp2_fraction(float x) /* 2^x, -0.5 <= x <= 0.5 */
{
...
static inline float G_GNUC_CONST gsl_signal_exp2(float x) /* 2^x, -3.5 <= x <= 3.5, prec>16bit */
{
    if_reject(x < -0.5)
    {
        if_reject(x < -1.5)
    ...
    else return _gsl_signal_exp2_fraction(x);
}
