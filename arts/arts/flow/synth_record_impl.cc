...
class Synth_RECORD_impl : virtual public Synth_RECORD_skel, virtual public ASConsumer, virtual public StdSynthModule {
#ifdef DEBUG_WAVEFORM
    ofstream plotfile;
#endif
protected:
...
public:
#ifdef DEBUG_WAVEFORM
    Synth_RECORD_impl() : plotfile("/dev/shm/synth_record.plot")
    {
    }
#endif
    /*
