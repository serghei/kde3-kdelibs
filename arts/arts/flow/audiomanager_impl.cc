...
public:
    ...
    void autoRestoreID(const string &newvalue)
    {
        _autoRestoreID = newvalue;
    }
    string autoRestoreID()
    {
        return _autoRestoreID;
    }
    ...
    void direction(AudioManagerDirection newvalue)
    {
        _direction = newvalue;
    }

    void constructor(AudioManagerDirection cdirection, const string &ctitle, const string &cautoRestoreID)
    {
    ...
    void destination(const string &newvalue)
    {
...
class Synth_AMAN_PLAY_impl : virtual public Synth_AMAN_PLAY_skel, virtual public AudioManagerAssignable, virtual public StdSynthModule {
protected:
...
public:
    ...
    void autoRestoreID(const string &newvalue)
    {
        client.autoRestoreID(newvalue);
    }
    string autoRestoreID()
    {
        return client.autoRestoreID();
    }
...
// this suffers a tiny bit from copypasting due to simpler
// inheritance hierarchy
class Synth_AMAN_RECORD_impl : virtual public Synth_AMAN_RECORD_skel, virtual public AudioManagerAssignable, virtual public StdSynthModule {
protected:
...
void AudioManager_impl::addAssignable(AudioManagerAssignable *a)
{
    ...
    if(client->destination().empty())
    {
        ...
        {
            case amPlay:
                client->destination("out_soundcard");
                break;
            case amRecord:
                client->destination("in_soundcard");
                break;
        }
    }
