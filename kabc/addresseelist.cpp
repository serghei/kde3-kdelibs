...
{
    return (QString::localeAwareCompare(a1.familyName(), a2.familyName()) == 0 && QString::localeAwareCompare(a1.givenName(), a2.givenName()) == 0);
}
...
{
    return (QString::localeAwareCompare(a1.givenName(), a2.givenName()) == 0 && QString::localeAwareCompare(a1.familyName(), a2.familyName()) == 0);
}
...
AddresseeList::AddresseeList() : QValueList< Addressee >()
{
...
AddresseeList::AddresseeList(const AddresseeList &l) : QValueList< Addressee >(l)
{
    mReverseSorting = l.reverseSorting();
    mActiveSortingCriterion = l.sortingCriterion();
}

AddresseeList::AddresseeList(const QValueList< Addressee > &l) : QValueList< Addressee >(l)
{
    mReverseSorting = false;
}
...
template < class Trait > void AddresseeList::sortByTrait()
{
