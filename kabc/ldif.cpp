...
QCString LDIF::assembleLine(const QString &fieldname, const QByteArray &value, uint linelen, bool url)
{
    bool safe = false;
    bool isDn;
    QCString result;
...
QCString LDIF::assembleLine(const QString &fieldname, const QCString &value, uint linelen, bool url)
{
    QCString ret;
    QByteArray tmp;
...
QCString LDIF::assembleLine(const QString &fieldname, const QString &value, uint linelen, bool url)
{
...
bool LDIF::splitControl(const QCString &line, QString &oid, bool &critical, QByteArray &value)
{
    QString tmp;
    critical = false;
