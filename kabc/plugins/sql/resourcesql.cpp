...
ResourceSql::ResourceSql(AddressBook *ab, const KConfig *config) : Resource(ab), mDb(0)
{
...
ResourceSql::ResourceSql(AddressBook *ab, const QString &user, const QString &password, const QString &db, const QString &host) : Resource(ab), mDb(0)
{
    init(user, password, db, host);
}

void ResourceSql::init(const QString &user, const QString &password, const QString &db, const QString &host)
{
    mUser = user;
    mPassword = password;
    mDbName = db;
