...
AddressBook::Iterator::Iterator() : d(new IteratorData)
{
}

AddressBook::Iterator::Iterator(const AddressBook::Iterator &i) : d(new IteratorData)
{
    d->mIt = i.d->mIt;
...
AddressBook::ConstIterator::ConstIterator() : d(new ConstIteratorData)
{
}

AddressBook::ConstIterator::ConstIterator(const AddressBook::ConstIterator &i) : d(new ConstIteratorData)
{
    d->mIt = i.d->mIt;
    d->mResources = i.d->mResources;
    d->mCurrRes = i.d->mCurrRes;
...
AddressBook::AddressBook() : d(new AddressBookData)
{
    d->mErrorHandler = 0;
    d->mConfig = 0;
...
AddressBook::AddressBook(const QString &config) : d(new AddressBookData)
{
    d->mErrorHandler = 0;
    if(config.isEmpty())
        d->mConfig = 0;
...
bool AddressBook::addCustomField(const QString &label, int category, const QString &key, const QString &app)
{
    if(d->mAllFields.isEmpty())
    {
        d->mAllFields = Field::allFields();
...
bool AddressBook::addResource(Resource *resource)
{
    ...
    connect(resource, SIGNAL(loadingFinished(Resource *)), this, SLOT(resourceLoadingFinished(Resource *)));
    connect(resource, SIGNAL(savingFinished(Resource *)), this, SLOT(resourceSavingFinished(Resource *)));

    connect(resource, SIGNAL(loadingError(Resource *, const QString &)), this, SLOT(resourceLoadingError(Resource *, const QString &)));
    connect(resource, SIGNAL(savingError(Resource *, const QString &)), this, SLOT(resourceSavingError(Resource *, const QString &)));
...
bool AddressBook::removeResource(Resource *resource)
{
    ...
    disconnect(resource, SIGNAL(loadingFinished(Resource *)), this, SLOT(resourceLoadingFinished(Resource *)));
    disconnect(resource, SIGNAL(savingFinished(Resource *)), this, SLOT(resourceSavingFinished(Resource *)));

    disconnect(resource, SIGNAL(loadingError(Resource *, const QString &)), this, SLOT(resourceLoadingError(Resource *, const QString &)));
    disconnect(resource, SIGNAL(savingError(Resource *, const QString &)), this, SLOT(resourceLoadingError(Resource *, const QString &)));
