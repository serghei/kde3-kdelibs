...
static const char classDef[] =
    ...
    "{\n"
    "        WidgetInfo widget;\n";
static const char widgetDef[] =
    "	widget.group = QString::fromLatin1(\"%Group\");\n"
    "#ifdef EMBED_IMAGES\n"
...
static const char endCtor[] =
    ...
    "{\n";
static const char widgetCreate[] =
    "         if (key == QString::fromLatin1(\"%Class\"))\n"
    "                return new %ImplClass%ConstructorArgs;\n";
static const char endCreate[] =
    "	return 0;\n"
    "}\n"
    "KDE_Q_EXPORT_PLUGIN(%PluginName)\n";


static KCmdLineOptions options[] = {{"+file", I18N_NOOP("Input file"), 0},
...
int main(int argc, char **argv)
{
    ...
    KAboutData about("makekdewidgets", I18N_NOOP("makekdewidgets"), version, description, KAboutData::License_GPL,
                     "(C) 2004-2005 ian reinhart geiser", 0, 0, "geiseri@kde.org");
