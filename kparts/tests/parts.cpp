...
Part1::Part1(QObject *parent, QWidget *parentWidget) : KParts::ReadOnlyPart(parent, "Part1")
{
...
Part2::Part2(QObject *parent, QWidget *parentWidget) : KParts::Part(parent, "Part2")
{
