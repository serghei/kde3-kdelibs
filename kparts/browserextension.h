...
struct KPARTS_EXPORT WindowArgs
{
    ...
    WindowArgs(int _x, int _y, int _width, int _height, bool _fullscreen, bool _menuBarVisible, bool _toolBarsVisible, bool _statusBarVisible,
               bool _resizable);
...
#define signals protected
    ...
    void popupMenu(KXMLGUIClient *client, const QPoint &global, const KFileItemList &items, const KParts::URLArgs &args,
     ...
     * The GUI described by @p client is being merged with the popupmenu of the host
     */
    void popupMenu(KXMLGUIClient *client, const QPoint &global, const KURL &url, const KParts::URLArgs &args, KParts::BrowserExtension::PopupFlags i,
...
protected:
    ...
    enum
    {
        VIRTUAL_FIND_FRAME_PARENT = 0x10
    };
