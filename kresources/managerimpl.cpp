    ...
    , mConfigRead(false)
{
    ...
    if(!connectDCOPSignal(0, "ManagerIface_" + family.utf8(), "signalKResourceAdded( QString, QString )", "dcopKResourceAdded( QString, QString )",
                          false))
        kdWarning(5650) << "Could not connect ResourceAdded signal!" << endl;

    if(!connectDCOPSignal(0, "ManagerIface_" + family.utf8(), "signalKResourceModified( QString, QString )",
                          "dcopKResourceModified( QString, QString )", false))
        kdWarning(5650) << "Could not connect ResourceModified signal!" << endl;

    if(!connectDCOPSignal(0, "ManagerIface_" + family.utf8(), "signalKResourceDeleted( QString, QString )",
...
void ManagerImpl::dcopKResourceAdded(QString managerId, QString resourceId)
{
    ...
    if(resource)
    {
        ...
        kdError() << "Received DCOP: resource added for unknown resource " << resourceId << endl;
}
...
void ManagerImpl::dcopKResourceModified(QString managerId, QString resourceId)
{
    ...
    if(resource)
    {
        ...
        kdError() << "Received DCOP: resource modified for unknown resource " << resourceId << endl;
}
...
void ManagerImpl::dcopKResourceDeleted(QString managerId, QString resourceId)
{
    ...
    if(resource)
    {
        ...
        kdError() << "Received DCOP: resource deleted for unknown resource " << resourceId << endl;
}
...
Resource *ManagerImpl::readResourceConfig(const QString &identifier, bool checkActive)
{
...
void ManagerImpl::writeResourceConfig(Resource *resource, bool checkActive)
{
    ...
    if(checkActive)
    {
        ...
        {
            if(passiveKeys.contains(key))
            { // remove it from passive list
