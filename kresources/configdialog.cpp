...
ConfigDialog::ConfigDialog(QWidget *parent, const QString &resourceFamily,
    ...
    : KDialogBase(parent, name, true, i18n("Resource Configuration"), Ok | Cancel, Ok, false) /*, mConfig( config )*/, mResource(resource)
{
    ...
    resourceGroupBox->setTitle(i18n("%1 Resource Settings").arg(factory->typeName(resource->type())));
