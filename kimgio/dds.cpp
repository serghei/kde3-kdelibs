...
#define MAKEFOURCC(ch0, ch1, ch2, ch3) (uint(uchar(ch0)) | (uint(uchar(ch1)) << 8) | (uint(uchar(ch2)) << 16) | (uint(uchar(ch3)) << 24))
#endif
...
#endif
static int face_flags[6] = {DDSCAPS2_CUBEMAP_POSITIVEX, DDSCAPS2_CUBEMAP_NEGATIVEX, DDSCAPS2_CUBEMAP_POSITIVEY,
