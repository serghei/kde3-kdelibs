...
public:
    MouseEvent(const char *name, QMouseEvent *qmouseEvent, int x, int y, const DOM::DOMString &url, const DOM::DOMString &target,
...
public:
    ...
    MouseDoubleClickEvent(QMouseEvent *mouseEvent, int x, int y, const DOM::DOMString &url, const DOM::DOMString &target, const DOM::Node &innerNode,
                          int clickCount = 2)
        : MouseEvent(s_strMouseDoubleClickEvent, mouseEvent, x, y, url, target, innerNode), m_clickCount(clickCount)
    {
    }
...
public:
    MouseReleaseEvent(QMouseEvent *mouseEvent, int x, int y, const DOM::DOMString &url, const DOM::DOMString &target, const DOM::Node &innerNode,
                      long = 0)
