...
QString KXEventUtil::getXAnyEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->serial).arg(e->send_event).arg((long)e->display, 0, 16).arg(winname).arg(e->window);
}
QString KXEventUtil::getXButtonEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->root).arg(e->subwindow).arg(e->time).arg(e->x).arg(e->y).arg(e->x_root).arg(e->y_root).arg(e->state).arg(e->button)
           + t.arg(e->same_screen);
}
...
QString KXEventUtil::getXKeyEventInfo(XEvent *xevent)
{
    ...
    QString t(" same_screen=%1");
    return s.arg(e->root).arg(e->subwindow).arg(e->time).arg(e->x).arg(e->y).arg(e->x_root).arg(e->y_root).arg(e->state).arg(e->keycode)
           + t.arg(e->same_screen);
}
...
QString KXEventUtil::getXMotionEventInfo(XEvent *xevent)
{
    ...
    QString t(" same_screen=%1");
    return s.arg(e->root).arg(e->subwindow).arg(e->time).arg(e->x).arg(e->y).arg(e->x_root).arg(e->y_root).arg(e->state).arg(e->is_hint)
           + t.arg(e->same_screen);
}
QString KXEventUtil::getXCrossingEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->root).arg(e->subwindow).arg(e->time).arg(e->x).arg(e->y).arg(e->x_root).arg(e->y_root).arg(e->mode).arg(ms)
           + t.arg(e->detail).arg(ds).arg(e->same_screen).arg(e->focus).arg(e->state);
}
QString KXEventUtil::getXFocusChangeEventInfo(XEvent *xevent)
{
    XFocusChangeEvent *e = &xevent->xfocus;
    QString s("mode=%1 detail=%2");
    return s.arg(e->mode).arg(e->detail);
}
QString KXEventUtil::getXExposeEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->x).arg(e->y).arg(e->width).arg(e->height).arg(e->count);
}
...
QString KXEventUtil::getXGraphicsExposeEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->x).arg(e->y).arg(e->width).arg(e->height).arg(e->count).arg(e->major_code).arg(e->minor_code);
}
QString KXEventUtil::getXNoExposeEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->major_code).arg(e->minor_code);
}
...
QString KXEventUtil::getXCreateWindowEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->window).arg(e->x).arg(e->y).arg(e->width).arg(e->height).arg(e->border_width).arg(e->override_redirect);
}
...
QString KXEventUtil::getXMappingEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->request).arg(e->first_keycode).arg(e->count);
}
...
QString KXEventUtil::getXConfigureEventInfo(XEvent *xevent)
{
    ...
    return s.arg(e->window).arg(e->x).arg(e->y).arg(e->width).arg(e->height).arg(e->border_width).arg(e->above).arg(e->override_redirect);
}
