...
KJavaDownloader::KJavaDownloader(int ID, const QString &url)
{
    ...
    connect(d->job, SIGNAL(connected(KIO::Job *)), this, SLOT(slotConnected(KIO::Job *)));
    connect(d->job, SIGNAL(mimetype(KIO::Job *, const QString &)), this, SLOT(slotMimetype(KIO::Job *, const QString &)));
...
void KJavaUploader::start()
{
    ...
    d->job->suspend();
    connect(d->job, SIGNAL(dataReq(KIO::Job *, QByteArray &)), this, SLOT(slotDataRequest(KIO::Job *, QByteArray &)));
    connect(d->job, SIGNAL(result(KIO::Job *)), this, SLOT(slotResult(KIO::Job *)));
