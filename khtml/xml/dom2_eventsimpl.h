...
public:
    ...
    UIEventImpl(EventId _id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, long detailArg);
    virtual ~UIEventImpl();
...
public:
    MouseEventImpl();
    MouseEventImpl(EventId _id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, long detailArg, long screenXArg, long screenYArg,
                   long clientXArg, long clientYArg, long pageXArg, long pageYArg, bool ctrlKeyArg, bool altKeyArg, bool shiftKeyArg, bool metaKeyArg,
                   unsigned short buttonArg, NodeImpl *relatedTargetArg, QMouseEvent *qe = 0, bool isDoubleClick = false);
...
public:
    ...
    void initKeyBaseEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg, unsigned long keyVal,
                          unsigned long virtKeyVal, unsigned long modifiers);

    bool ctrlKey() const
    {
        return m_modifier & Qt::ControlButton;
    }
    bool shiftKey() const
    {
        return m_modifier & Qt::ShiftButton;
    }
    bool altKey() const
    {
        return m_modifier & Qt::AltButton;
    }
    bool metaKey() const
    {
        return m_modifier & Qt::MetaButton;
    }
...
protected:
    ...
    KeyEventBaseImpl(EventId id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, QKeyEvent *key);
...
public:
    ...
    void initTextEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg, const DOMString &text);
...
public:
    ...
    void initKeyboardEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg,
    ...
    void initKeyboardEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg, unsigned long keyVal,
                           unsigned long virtKeyVal, unsigned long modifiers, unsigned long keyLocationArg)
    {
...
public:
    MutationEventImpl();
    MutationEventImpl(EventId _id, bool canBubbleArg, bool cancelableArg, const Node &relatedNodeArg, const DOMString &prevValueArg,
...
public:
    ...
    RegisteredEventListener(EventImpl::EventId _id, EventListener *_listener, bool _useCapture)
        : id(_id), useCapture(_useCapture), listener(_listener)
    {
        if(listener)
            listener->ref();
    }
    ...
    RegisteredEventListener(const RegisteredEventListener &other) : id(other.id), useCapture(other.useCapture), listener(other.listener)
    {
        if(listener)
            listener->ref();
    }
