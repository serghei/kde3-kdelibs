...
UIEventImpl::UIEventImpl(EventId _id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, long detailArg)
...
void UIEventImpl::initUIEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg, long detailArg)
{
...
MouseEventImpl::MouseEventImpl(EventId _id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, long detailArg, long screenXArg,
                               long screenYArg, long clientXArg, long clientYArg, long pageXArg, long pageYArg, bool ctrlKeyArg, bool altKeyArg,
                               bool shiftKeyArg, bool metaKeyArg, unsigned short buttonArg, NodeImpl *relatedTargetArg, QMouseEvent *qe,
                               bool isDoubleClick)
...
template < typename L, typename R, typename MemL > class IDTranslator {
public:
    struct Info
    {
        MemL l;
...
#define MAKE_TRANSLATOR(name, L, R, MR, table)                                                                                                       \
    static IDTranslator< L, R, MR > *s_##name;                                                                                                       \
    static IDTranslator< L, R, MR > *name()                                                                                                          \
    {                                                                                                                                                \
        if(!s_##name)                                                                                                                                \
            s_##name = new IDTranslator< L, R, MR >(table);                                                                                          \
        return s_##name;                                                                                                                             \
    }
...
IDTranslator< unsigned, unsigned, unsigned >::Info virtKeyToQtKeyTable[] = {{KeyEventBaseImpl::DOM_VK_BACK_SPACE, Qt::Key_Backspace},
...
KeyEventBaseImpl::KeyEventBaseImpl(EventId id, bool canBubbleArg, bool cancelableArg, AbstractViewImpl *viewArg, QKeyEvent *key)
...
void KeyEventBaseImpl::initKeyBaseEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const AbstractView &viewArg,
                                        unsigned long keyValArg, unsigned long virtKeyValArg, unsigned long modifiersArg)
{
    m_synthetic = true;
    delete m_keyEvent;
    m_keyEvent = 0;
...
void KeyEventBaseImpl::initModifier(unsigned long modifierArg, bool valueArg)
{
    if(valueArg)
...
void KeyEventBaseImpl::buildQKeyEvent() const
{
    ...
    m_keyEvent = new QKeyEvent(id() == KEYUP_EVENT ? QEvent::KeyRelease : QEvent::KeyPress, key, ascii, modifiers, text);
}
...
static const IDTranslator< QCString, unsigned, const char * >::Info keyModifiersToCodeTable[] = {{"Alt", Qt::AltButton},
...
TextEventImpl::TextEventImpl(QKeyEvent *key, DOM::AbstractViewImpl *view) : KeyEventBaseImpl(KEYPRESS_EVENT, true, true, view, key)
{
...
void MutationEventImpl::initMutationEvent(const DOMString &typeArg, bool canBubbleArg, bool cancelableArg, const Node &relatedNodeArg,
