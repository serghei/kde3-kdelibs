...
template < class DATA > class DataRef {
public:
    DataRef()
    {
        data = 0;
...
public:
    ...
    {
        return (clip == o.clip && palette == o.palette);
    }
    bool operator!=(const StyleVisualData &o) const
    {
        return !(*this == o);
...
public:
    ...
    bool backgroundAttachment() const
    {
        return m_bgAttachment;
    }
    ...
    void setBackgroundAttachment(bool b)
    {
        m_bgAttachment = b;
...
public:
    ...
    {
        return noninherited_flags.f._styleType;
    }
    ...
    {
        return noninherited_flags.f._display;
    }
    EDisplay originalDisplay() const
    {
        return noninherited_flags.f._originalDisplay;
    }
    ...
    {
        return noninherited_flags.f._position;
    }
    EFloat floating() const
    {
        return noninherited_flags.f._floating;
    }
    ...
    {
        return noninherited_flags.f._overflowX;
    }
    EOverflow overflowY() const
    {
        return noninherited_flags.f._overflowY;
    }
    ...
    {
        return inherited_flags.f._visibility;
    }
    EVerticalAlign verticalAlign() const
    {
        return noninherited_flags.f._vertical_align;
    }
    ...
    {
        return noninherited_flags.f._unicodeBidi;
    }

    EClear clear() const
    {
        return noninherited_flags.f._clear;
    }
    ETableLayout tableLayout() const
    {
        return noninherited_flags.f._table_layout;
    }

    const QFont &font() const
    {
        return inherited->font.f;
    }
    ...
    {
        return inherited_flags.f._text_align;
    }
    ETextTransform textTransform() const
    {
        return inherited_flags.f._text_transform;
    }
    ...
    {
        return inherited_flags.f._direction;
    }
    ...
    {
        return inherited_flags.f._white_space;
    }
    bool autoWrap() const
    {
    ...
    EBackgroundRepeat backgroundRepeat() const
    {
        return background->m_background.m_bgRepeat;
    }
    bool backgroundAttachment() const
    {
        return background->m_background.m_bgAttachment;
    }
    Length backgroundXPosition() const
    {
    ...
    {
        return inherited_flags.f._empty_cells;
    }
    ECaptionSide captionSide() const
    {
        return inherited_flags.f._caption_side;
    }

    EListStyleType listStyleType() const
    {
        return inherited_flags.f._list_style_type;
    }
    ...
    {
        return inherited_flags.f._list_style_position;
    }
    ...
    {
        return inherited_flags.f._cursor_style;
    }
    ...
    {
        return noninherited_flags.f._page_break_before;
    }
    EPageBreak pageBreakAfter() const
    {
        return noninherited_flags.f._page_break_after;
    }
    ...
    {
        return inherited_flags.f._user_input;
    }

    Length marqueeIncrement()
    {
    ...
    EMarqueeBehavior marqueeBehavior()
    {
        return css3NonInheritedData->marquee->behavior;
    }
    EMarqueeDirection marqueeDirection()
    {
    ...
    void resetPadding()
    {
        SET_VAR(surround, padding, LengthBox(Variable))
    }
    ...
    static bool initialBackgroundAttachment()
    {
        return true;
    }
