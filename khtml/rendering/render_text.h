...
private:
    ...
    InlineTextBox(int _x, int _y) : InlineBox(0)
    {
        m_x = _x;
        m_y = _y;
        m_reversed = false;
...
public:
    ...
    void trimmedMinMaxWidth(short &beginMinW, bool &beginWS, short &endMinW, bool &endWS, bool &hasBreakableChar, bool &hasBreak, short &beginMaxW,
                            short &endMaxW, short &minW, short &maxW, bool &stripFrontSpaces);
     ...
     */
    unsigned inlineTextBoxCount() const
    {
        return m_lines.count();
    }
    /** returns the array of inline text boxes for this render text.
     */
    const InlineTextBoxArray &inlineTextBoxes() const
    {
        return m_lines;
    }
     ...
     */
    InlineTextBox *findInlineTextBox(int offset, int &pos, bool checkFirstLetter = false);
...
public:
    RenderTextFragment(DOM::NodeImpl *_node, DOM::DOMStringImpl *_str, int startOffset, int endOffset);
