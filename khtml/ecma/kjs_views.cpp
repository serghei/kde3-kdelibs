...
DOMAbstractView::DOMAbstractView(ExecState *exec, DOM::AbstractView av) : DOMObject(exec->interpreter()->builtinObjectPrototype()), abstractView(av)
{
}
        ...
        case DOMAbstractView::GetComputedStyle:
        {
            ...
            if(arg0.nodeType() != DOM::Node::ELEMENT_NODE)
                ...
                return getDOMCSSStyleDeclaration(exec,
                                                 abstractView.getComputedStyle(static_cast< DOM::Element >(arg0), args[1].toString(exec).string()));
        }
    }
    return Undefined();
}
