...
DOMRange::DOMRange(ExecState *exec, DOM::Range r) : DOMObject(DOMRangeProto::self(exec)), range(r)
{
}
...
RangeConstructor::RangeConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
