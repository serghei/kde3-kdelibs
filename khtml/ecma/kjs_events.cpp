...
JSLazyEventListener::JSLazyEventListener(const QString &_code, const QString &_name, const Object &_win, DOM::NodeImpl *_originalNode)
    : JSEventListener(Object(), 0, _win, true), code(_code), name(_name), parsed(false)
{
...
void JSLazyEventListener::parseCode() const
{
    if(!parsed)
    {
        ...
        if(listener.isValid())
        {
            static_cast< Window * >(win.imp())->jsEventListeners.insert(listener.imp(), (KJS::JSEventListener *)(this));
        }
...
DOMEvent::DOMEvent(ExecState *exec, DOM::Event e) : DOMObject(DOMEventProto::self(exec)), event(e)
{
}

DOMEvent::DOMEvent(const Object &proto, DOM::Event e) : DOMObject(proto), event(e)
{
}
...
void DOMEvent::tryPut(ExecState *exec, const Identifier &propertyName, const Value &value, int attr)
{
    DOMObjectLookupPut< DOMEvent, DOMObject >(exec, propertyName, value, attr, &DOMEventTable, this);
}
...
@end
*/
EventExceptionConstructor::EventExceptionConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
...
DOMUIEvent::DOMUIEvent(ExecState *exec, DOM::UIEvent ue) : DOMEvent(DOMUIEventProto::self(exec), ue)
{
}

DOMUIEvent::DOMUIEvent(const Object &proto, DOM::UIEvent ue) : DOMEvent(proto, ue)
{
}
...
Value DOMUIEventProtoFunc::tryCall(ExecState *exec, Object &thisObj, const List &args)
{
    ...
    switch(id)
    {
        case DOMUIEvent::InitUIEvent:
        {
            ...
            static_cast< DOM::UIEvent >(uiEvent).initUIEvent(args[0].toString(exec).string(), args[1].toBoolean(exec), args[2].toBoolean(exec), v,
...
DOMMouseEvent::DOMMouseEvent(ExecState *exec, DOM::MouseEvent me) : DOMUIEvent(DOMMouseEventProto::self(exec), me)
{
}
...
DOMKeyEventBase::DOMKeyEventBase(const Object &proto, DOM::TextEvent ke) : DOMUIEvent(proto, ke)
{
}
...
DOMTextEvent::DOMTextEvent(ExecState *exec, DOM::TextEvent ke) : DOMKeyEventBase(DOMTextEventProto::self(exec), ke)
{
}
...
DOMKeyboardEvent::DOMKeyboardEvent(ExecState *exec, DOM::TextEvent ke) : DOMKeyEventBase(DOMKeyboardEventProto::self(exec), ke)
{
}
...
@end
*/
KeyboardEventConstructor::KeyboardEventConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
...
@end
*/
MutationEventConstructor::MutationEventConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
...
DOMMutationEvent::DOMMutationEvent(ExecState *exec, DOM::MutationEvent me) : DOMEvent(DOMMutationEventProto::self(exec), me)
{
}
