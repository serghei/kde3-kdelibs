...
DOMStyleSheet::DOMStyleSheet(ExecState *exec, const DOM::StyleSheet &ss) : DOMObject(exec->interpreter()->builtinObjectPrototype()), styleSheet(ss)
{
}
...
DOMMediaList::DOMMediaList(ExecState *exec, const DOM::MediaList &ml) : DOMObject(DOMMediaListProto::self(exec)), mediaList(ml)
{
}
...
KJS_IMPLEMENT_PROTOTYPE("DOMCSSStyleSheet", DOMCSSStyleSheetProto,
                        DOMCSSStyleSheetProtoFunc) // warning, use _WITH_PARENT if DOMStyleSheet gets a proto

DOMCSSStyleSheet::DOMCSSStyleSheet(ExecState *exec, const DOM::CSSStyleSheet &ss) : DOMStyleSheet(DOMCSSStyleSheetProto::self(exec), ss)
{
}
...
DOMCSSRule::DOMCSSRule(ExecState *exec, const DOM::CSSRule &r) : DOMObject(exec->interpreter()->builtinObjectPrototype()), cssRule(r)
{
}
...
CSSRuleConstructor::CSSRuleConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
...
DOMCSSValue::DOMCSSValue(ExecState *exec, const DOM::CSSValue &val) : DOMObject(exec->interpreter()->builtinObjectPrototype()), cssValue(val)
{
}
...
CSSValueConstructor::CSSValueConstructor(ExecState *exec) : DOMObject(exec->interpreter()->builtinObjectPrototype())
{
}
...
DOMCSSPrimitiveValue::DOMCSSPrimitiveValue(ExecState *exec, const DOM::CSSPrimitiveValue &v) : DOMCSSValue(DOMCSSPrimitiveValueProto::self(exec), v)
{
}
...
DOMCSSValueList::DOMCSSValueList(ExecState *exec, const DOM::CSSValueList &v) : DOMCSSValue(exec, v)
{
}
...
DOMRGBColor::DOMRGBColor(ExecState *exec, const DOM::RGBColor &c) : DOMObject(exec->interpreter()->builtinObjectPrototype()), rgbColor(c)
{
}
...
{
    return DOMObjectLookupGetValue< DOMRGBColor, DOMObject >(exec, p, &DOMRGBColorTable, this);
}
...
DOMRect::DOMRect(ExecState *exec, const DOM::Rect &r) : DOMObject(exec->interpreter()->builtinObjectPrototype()), rect(r)
{
}
...
{
    return DOMObjectLookupGetValue< DOMRect, DOMObject >(exec, p, &DOMRectTable, this);
}
...
@end
*/
DOMCounter::DOMCounter(ExecState *exec, const DOM::Counter &c) : DOMObject(exec->interpreter()->builtinObjectPrototype()), counter(c)
{
}
...
{
    return DOMObjectLookupGetValue< DOMCounter, DOMObject >(exec, p, &DOMCounterTable, this);
}
