...
public:
    ...
    {
        return static_cast< DOM::UIEvent >(event);
    }
};
...
public:
    ...
    {
        return static_cast< DOM::MouseEvent >(event);
    }
};
...
public:
    ...
    {
        return static_cast< DOM::KeyEventBaseImpl * >(event.handle());
    }
};
...
public:
    ...
    {
        return static_cast< DOM::TextEventImpl * >(event.handle());
    }
};
...
public:
    ...
    {
        return static_cast< DOM::KeyboardEventImpl * >(event.handle());
    }
};
...
public:
    ...
    {
        return static_cast< DOM::MutationEvent >(event);
    }
};
