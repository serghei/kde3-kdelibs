...
HTMLAppletElement::HTMLAppletElement(const HTMLAppletElement &other) : HTMLElement(other)
{
}

HTMLAppletElement::HTMLAppletElement(HTMLAppletElementImpl *impl) : HTMLElement(impl)
{
}
