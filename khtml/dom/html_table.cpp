...
{
    if(other.elementId() != ID_TD && other.elementId() != ID_TH)
    {
        if(impl)
            impl->deref();
        impl = 0;
...
{
    if(other.elementId() != ID_COL && other.elementId() != ID_COLGROUP)
    {
        if(impl)
            impl->deref();
        impl = 0;
...
{
    if(impl)
        ((HTMLTableElementImpl *)impl)->setCaption(((HTMLTableCaptionElementImpl *)_caption.impl));
}
...
void HTMLTableElement::setTHead(const HTMLTableSectionElement &_tHead)
{
    ...
    if(impl)
        ((HTMLTableElementImpl *)impl)->setTHead(((HTMLTableSectionElementImpl *)_tHead.impl));
}
...
void HTMLTableElement::setTFoot(const HTMLTableSectionElement &_tFoot)
{
    ...
    if(impl)
        ((HTMLTableElementImpl *)impl)->setTFoot(((HTMLTableSectionElementImpl *)_tFoot.impl));
}
...
{
    if(other.elementId() != ID_TBODY && other.elementId() != ID_THEAD && other.elementId() != ID_TFOOT)
    {
        if(impl)
            impl->deref();
        impl = 0;
