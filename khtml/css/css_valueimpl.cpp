...
CSSStyleDeclarationImpl::CSSStyleDeclarationImpl(CSSRuleImpl *parent) : StyleBaseImpl(parent)
{
    m_lstValues = 0;
    m_node = 0;
}

CSSStyleDeclarationImpl::CSSStyleDeclarationImpl(CSSRuleImpl *parent, QPtrList< CSSProperty > *lstValues) : StyleBaseImpl(parent)
{
...
DOMString CSSStyleDeclarationImpl::getPropertyValue(int propertyID) const
{
    ...
    switch(propertyID)
    {
        ...
        {
            const int properties[5] = {CSS_PROP_BACKGROUND_IMAGE, CSS_PROP_BACKGROUND_REPEAT, CSS_PROP_BACKGROUND_ATTACHMENT,
                                       CSS_PROP_BACKGROUND_POSITION, CSS_PROP_BACKGROUND_COLOR};
...
bool CSSStyleDeclarationImpl::setProperty(int id, const DOMString &value, bool important, bool nonCSSHint)
{
    ...
    if(!success)
        kdDebug(6080) << "CSSStyleDeclarationImpl::setProperty invalid property: [" << getPropertyName(id).string() << "] value: [" << value.string()
                      << "]" << endl;
    else
        setChanged();
    return success;
...
{
    return (m_parent && m_parent->isRule()) ? static_cast< CSSRuleImpl * >(m_parent) : 0;
}
...
CSSPrimitiveValueImpl::CSSPrimitiveValueImpl() : CSSValueImpl()
{
    m_type = 0;
}

CSSPrimitiveValueImpl::CSSPrimitiveValueImpl(int ident) : CSSValueImpl()
{
    m_value.ident = ident;
        ...
        case CSSPrimitiveValue::CSS_RGBCOLOR:
            if(qAlpha(m_value.rgbcolor) != 0xFF)
            {
                if(m_value.rgbcolor == khtml::transparentColor)
                    ...
                    text = "rgba(" + QString::number(qRed(m_value.rgbcolor)) + "," + QString::number(qBlue(m_value.rgbcolor)) + ","
                           + QString::number(qGreen(m_value.rgbcolor)) + "," + QString::number(qAlpha(m_value.rgbcolor) / 255.0) + ")";
            }
            else
            {
...
CSSImageValueImpl::CSSImageValueImpl(const DOMString &url, const StyleBaseImpl *style) : CSSPrimitiveValueImpl(url, CSSPrimitiveValue::CSS_URI)
{
...
CSSImageValueImpl::CSSImageValueImpl() : CSSPrimitiveValueImpl(CSS_VAL_NONE)
{
    m_image = 0;
}
...
FontFamilyValueImpl::FontFamilyValueImpl(const QString &string) : CSSPrimitiveValueImpl(DOMString(string), CSSPrimitiveValue::CSS_STRING)
{
...
ShadowValueImpl::ShadowValueImpl(CSSPrimitiveValueImpl *_x, CSSPrimitiveValueImpl *_y, CSSPrimitiveValueImpl *_blur, CSSPrimitiveValueImpl *_color)
