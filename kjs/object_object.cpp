...
ObjectPrototypeImp::ObjectPrototypeImp(ExecState *exec, FunctionPrototypeImp *funcProto) : ObjectImp() // [[Prototype]] is Null()
{
    Value protect(this);
    ...
    putDirect(toLocaleStringPropertyName, new ObjectProtoFuncImp(exec, funcProto, ObjectProtoFuncImp::ToLocaleString, 0, toLocaleStringPropertyName),
              DontEnum);
    putDirect(valueOfPropertyName, new ObjectProtoFuncImp(exec, funcProto, ObjectProtoFuncImp::ValueOf, 0, valueOfPropertyName), DontEnum);
    putDirect("hasOwnProperty", new ObjectProtoFuncImp(exec, funcProto, ObjectProtoFuncImp::HasOwnProperty, 1, "hasOwnProperty"), DontEnum);
    putDirect("isPrototypeOf", new ObjectProtoFuncImp(exec, funcProto, ObjectProtoFuncImp::IsPrototypeOf, 1, "isPrototypeOf"), DontEnum);
    putDirect("propertyIsEnumerable", new ObjectProtoFuncImp(exec, funcProto, ObjectProtoFuncImp::PropertyIsEnumerable, 1, "propertyIsEnumerable"),
              DontEnum);
    ...
    put(exec, "eval", Object(new GlobalFuncImp(exec, funcProto, GlobalFuncImp::Eval, 1, "eval")), DontEnum);
#endif
}

// ------------------------------ ObjectProtoFuncImp --------------------------------

ObjectProtoFuncImp::ObjectProtoFuncImp(ExecState * /*exec*/, FunctionPrototypeImp *funcProto, int i, int len, const Identifier &_ident)
...
ObjectObjectImp::ObjectObjectImp(ExecState * /*exec*/, ObjectPrototypeImp *objProto, FunctionPrototypeImp *funcProto) : InternalFunctionImp(funcProto)
{
    Value protect(this);
    // ECMA 15.2.3.1
