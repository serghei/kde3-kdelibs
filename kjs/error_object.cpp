...
ErrorInstanceImp::ErrorInstanceImp(ObjectImp *proto) : ObjectImp(proto)
{
}
...
// ECMA 15.9.4
ErrorPrototypeImp::ErrorPrototypeImp(ExecState *exec, ObjectPrototypeImp *objectProto, FunctionPrototypeImp *funcProto) : ObjectImp(objectProto)
{
    Value protect(this);
...
ErrorProtoFuncImp::ErrorProtoFuncImp(ExecState * /*exec*/, FunctionPrototypeImp *funcProto) : InternalFunctionImp(funcProto)
{
    Value protect(this);
...
ErrorObjectImp::ErrorObjectImp(ExecState * /*exec*/, FunctionPrototypeImp *funcProto, ErrorPrototypeImp *errorProto) : InternalFunctionImp(funcProto)
{
    Value protect(this);
...
NativeErrorPrototypeImp::NativeErrorPrototypeImp(ExecState * /*exec*/, ErrorPrototypeImp *errorProto, ErrorType et, UString name, UString message)
...
NativeErrorImp::NativeErrorImp(ExecState * /*exec*/, FunctionPrototypeImp *funcProto, const Object &prot) : InternalFunctionImp(funcProto), proto(0)
{
    Value protect(this);
