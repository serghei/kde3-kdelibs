...
inline Value lookupOrCreateFunction(ExecState *exec, const Identifier &propertyName, const ObjectImp *thisObj, int token, int params, int attr)
{
...
inline Value lookupGet(ExecState *exec, const Identifier &propertyName, const HashTable *table, const ThisImp *thisObj)
{
...
inline Value lookupGetFunction(ExecState *exec, const Identifier &propertyName, const HashTable *table, const ObjectImp *thisObj)
{
    const HashEntry *entry = Lookup::findEntry(table, propertyName);
...
inline Value lookupGetValue(ExecState *exec, const Identifier &propertyName, const HashTable *table, const ThisImp *thisObj)
{
    const HashEntry *entry = Lookup::findEntry(table, propertyName);
 ...
 */
template < class ThisImp, class ParentImp >
inline void lookupPut(ExecState *exec, const Identifier &propertyName, const Value &value, int attr, const HashTable *table, ThisImp *thisObj)
{
    const HashEntry *entry = Lookup::findEntry(table, propertyName);
 ...
 */
template < class ClassCtor > inline KJS::Object cacheGlobalObject(ExecState *exec, const Identifier &propertyName)
{
...
#define IMPLEMENT_PROTOFUNC(ClassFunc)                                                                                                               \
    namespace KJS {                                                                                                                                  \
        ...
        public:                                                                                                                                      \
            ClassFunc(KJS::ExecState *exec, int i, int len) : ObjectImp(/*proto? */), id(i)                                                          \
            {                                                                                                                                        \
