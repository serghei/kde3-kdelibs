...
static const KCmdLineOptions options[] = {{"+[directory ...]", "Directory(ies) to watch", 0}, KCmdLineLastOption};


int main(int argc, char **argv)
{
    KCmdLineArgs::init(argc, argv, "KDirWatchTest", "Test for KDirWatch", "1.0");
