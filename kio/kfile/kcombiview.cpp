...
// $Id: kcombiview.cpp 465272 2005-09-29 09:47:40Z mueller $
...
KCombiView::KCombiView(QWidget *parent, const char *name)
    : QSplitter(parent, name), KFileView(), right(0), m_lastViewForNextItem(0), m_lastViewForPrevItem(0)
{
    ...
    connect(sig, SIGNAL(sortingChanged(QDir::SortSpec)), SLOT(slotSortingChanged(QDir::SortSpec)));
}
