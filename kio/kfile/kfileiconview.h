...
public:
    KFileIconViewItem(QIconView *parent, const QString &text, const QPixmap &pixmap, KFileItem *fi) : KIconViewItem(parent, text, pixmap), inf(fi)
    {
    }
    /**
     * @since 3.1
     */
    KFileIconViewItem(QIconView *parent, KFileItem *fi) : KIconViewItem(parent), inf(fi)
    {
    }
...
private:
    ...
    virtual void insertItem(QIconViewItem *a, QIconViewItem *b)
    {
    ...
    virtual void setSelected(QIconViewItem *i, bool a, bool b)
    {
    ...
    void initItem(KFileIconViewItem *item, const KFileItem *i, bool updateTextAndPixmap);
