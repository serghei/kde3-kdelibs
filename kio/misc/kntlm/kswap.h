...
inline Q_INT32 KSWAP_32(Q_INT32 b)
{
    return (((((Q_UINT32)b) & 0xff000000) >> 24) | ((((Q_UINT32)b) & 0x00ff0000) >> 8) | ((((Q_UINT32)b) & 0x0000ff00) << 8)
            | ((((Q_UINT32)b) & 0x000000ff) << 24));
}
