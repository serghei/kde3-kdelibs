...
void KSSLCertificateCache::reload()
{
    ...
    d->dcc->call("kded", "kssld", "cacheReload()", data, rettype, retval);
}


void KSSLCertificateCache::addCertificate(KSSLCertificate &cert, KSSLCertificatePolicy policy, bool permanent)
{
    QByteArray data, retval;
    QCString rettype;
    QDataStream arg(data, IO_WriteOnly);
    ...
    arg << policy;
    arg << permanent;
    d->dcc->call("kded", "kssld", "cacheAddCertificate(KSSLCertificate,KSSLCertificateCache::KSSLCertificatePolicy,bool)", data, rettype, retval);
}
...
KSSLCertificateCache::KSSLCertificatePolicy KSSLCertificateCache::getPolicyByCN(QString &cn)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cn;
    bool rc = d->dcc->call("kded", "kssld", "cacheGetPolicyByCN(QString)", data, rettype, retval);
...
KSSLCertificateCache::KSSLCertificatePolicy KSSLCertificateCache::getPolicyByCertificate(KSSLCertificate &cert)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert;
    bool rc = d->dcc->call("kded", "kssld", "cacheGetPolicyByCertificate(KSSLCertificate)", data, rettype, retval);
...
bool KSSLCertificateCache::seenCN(QString &cn)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cn;
    bool rc = d->dcc->call("kded", "kssld", "cacheSeenCN(QString)", data, rettype, retval);
...
bool KSSLCertificateCache::seenCertificate(KSSLCertificate &cert)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert;
    bool rc = d->dcc->call("kded", "kssld", "cacheSeenCertificate(KSSLCertificate)", data, rettype, retval);
...
bool KSSLCertificateCache::isPermanent(KSSLCertificate &cert)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert;
    bool rc = d->dcc->call("kded", "kssld", "cacheIsPermanent(KSSLCertificate)", data, rettype, retval);
...
bool KSSLCertificateCache::removeByCN(QString &cn)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cn;
    bool rc = d->dcc->call("kded", "kssld", "cacheRemoveByCN(QString)", data, rettype, retval);
...
bool KSSLCertificateCache::removeByCertificate(KSSLCertificate &cert)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert;
    bool rc = d->dcc->call("kded", "kssld", "cacheRemoveByCertificate(KSSLCertificate)", data, rettype, retval);
...
// KDE 4: Make it const QString &
bool KSSLCertificateCache::modifyByCN(QString &cn, KSSLCertificateCache::KSSLCertificatePolicy policy, bool permanent, QDateTime &expires)
{
    QByteArray data, retval;
    QCString rettype;
    QDataStream arg(data, IO_WriteOnly);
    ...
    bool rc =
        d->dcc->call("kded", "kssld", "cacheModifyByCN(QString,KSSLCertificateCache::KSSLCertificatePolicy,bool,QDateTime)", data, rettype, retval);
...
bool KSSLCertificateCache::modifyByCertificate(KSSLCertificate &cert, KSSLCertificateCache::KSSLCertificatePolicy policy, bool permanent,
                                               QDateTime &expires)
{
    QByteArray data, retval;
    QCString rettype;
    ...
    bool rc = d->dcc->call("kded", "kssld", "cacheModifyByCertificate(KSSLCertificate,KSSLCertificateCache::KSSLCertificatePolicy,bool,QDateTime)",
                           data, rettype, retval);
...
QStringList KSSLCertificateCache::getHostList(KSSLCertificate &cert)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert;
    bool rc = d->dcc->call("kded", "kssld", "cacheGetHostList(KSSLCertificate)", data, rettype, retval);
...
bool KSSLCertificateCache::addHost(KSSLCertificate &cert, QString &host)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert << host;
    bool rc = d->dcc->call("kded", "kssld", "cacheAddHost(KSSLCertificate,QString)", data, rettype, retval);
...
bool KSSLCertificateCache::removeHost(KSSLCertificate &cert, QString &host)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << cert << host;
    bool rc = d->dcc->call("kded", "kssld", "cacheRemoveHost(KSSLCertificate,QString)", data, rettype, retval);
...
QStringList KSSLCertificateCache::getKDEKeyByEmail(const QString &email)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << email;
    bool rc = d->dcc->call("kded", "kssld", "getKDEKeyByEmail(QString)", data, rettype, retval);
...
KSSLCertificate *KSSLCertificateCache::getCertByMD5Digest(const QString &key)
{
    ...
    QDataStream arg(data, IO_WriteOnly);
    arg << key;
    bool rc = d->dcc->call("kded", "kssld", "getCertByMD5Digest(QString)", data, rettype, retval);
