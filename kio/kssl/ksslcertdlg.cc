...
KSSLCertDlg::KSSLCertDlg(QWidget *parent, const char *name, bool modal) : KDialog(parent, name, modal), d(new KSSLCertDlgPrivate)
{

    QBoxLayout *grid = new QVBoxLayout(this, KDialog::marginHint(), KDialog::spacingHint());
