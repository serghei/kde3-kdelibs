 ...
 * @return the job handling the operation.
 */
KIO_EXPORT TransferJob *http_post(const KURL &url, const QByteArray &postData, bool showProgressInfo = true);
 ...
 * @since 3.3
 */
KIO_EXPORT StoredTransferJob *storedPut(const QByteArray &arr, const KURL &url, int permissions, bool overwrite, bool resume,
 ...
 * @return the job handling the operation.
 */
KIO_EXPORT FileCopyJob *file_copy(const KURL &src, const KURL &dest, int permissions = -1, bool overwrite = false, bool resume = false,
                                  bool showProgressInfo = true);
 ...
 * @return the job handling the operation.
 */
KIO_EXPORT FileCopyJob *file_move(const KURL &src, const KURL &dest, int permissions = -1, bool overwrite = false, bool resume = false,
                                  bool showProgressInfo = true);
