...
public:
     ...
     * @return the pixmap of the URL, can be a default icon if not found
     */
    static QPixmap pixmapForURL(const KURL &_url, mode_t _mode = 0, KIcon::Group _group = KIcon::Desktop, int _force_size = 0, int _state = 0,
                                QString *_path = 0L);
