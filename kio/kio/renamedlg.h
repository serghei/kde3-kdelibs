...
public:
    ...
    RenameDlg(QWidget *parent, const QString &caption,
              ...
              const QString &src, const QString &dest, RenameDlg_Mode mode, KIO::filesize_t sizeSrc = (KIO::filesize_t)-1,
              KIO::filesize_t sizeDest = (KIO::filesize_t)-1, time_t ctimeSrc = (time_t)-1, time_t ctimeDest = (time_t)-1,
              time_t mtimeSrc = (time_t)-1, time_t mtimeDest = (time_t)-1, bool modal = false);
    ~RenameDlg();
...
KIO_EXPORT RenameDlg_Result open_RenameDlg(const QString &caption,
                                           ...
                                           const QString &src, const QString &dest, RenameDlg_Mode mode, QString &newDestPath,
                                           KIO::filesize_t sizeSrc = (KIO::filesize_t)-1, KIO::filesize_t sizeDest = (KIO::filesize_t)-1,
                                           time_t ctimeSrc = (time_t)-1, time_t ctimeDest = (time_t)-1, time_t mtimeSrc = (time_t)-1,
