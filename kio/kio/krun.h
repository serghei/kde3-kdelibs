...
public:
     ...
     * @return the process id, or 0 on error
     */
    static pid_t run(const QString &_exec, const KURL::List &_urls, const QString &_name = QString::null, const QString &_icon = QString::null,
                     const QString &_obsolete1 = QString::null, const QString &_obsolete2 = QString::null);
...
private:
    void init(const KURL &url, QWidget *window, mode_t mode, bool isLocalFile, bool showProgressInfo);
