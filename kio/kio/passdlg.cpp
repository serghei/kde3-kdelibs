...
PasswordDialog::PasswordDialog(const QString &prompt, const QString &user, bool enableKeep, bool modal, QWidget *parent, const char *name)
...
void PasswordDialog::init(const QString &prompt, const QString &user, bool enableKeep)
{
...
void PasswordDialog::addCommentLine(const QString &label, const QString comment)
{
    if(d->nRow > 0)
        return;
...
void PasswordDialog::setKnownLogins(const QMap< QString, QString > &knownLogins)
{
    ...
    connect(d->userEditCombo, SIGNAL(activated(const QString &)), this, SLOT(slotActivated(const QString &)));
}
...
int PasswordDialog::getNameAndPassword(QString &user, QString &pass, bool *keep, const QString &prompt, bool readOnly, const QString &caption,
