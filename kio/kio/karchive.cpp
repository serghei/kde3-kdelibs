...
bool KArchive::prepareWriting_impl(const QString &name, const QString &user, const QString &group, uint size, mode_t /*perm*/, time_t /*atime*/,
...
bool KArchive::writeFile_impl(const QString &name, const QString &user, const QString &group, uint size, mode_t perm, time_t atime, time_t mtime,
                              time_t ctime, const char *data)
{
...
bool KArchive::writeDir_impl(const QString &name, const QString &user, const QString &group, mode_t /*perm*/, time_t /*atime*/, time_t /*mtime*/,
                             time_t /*ctime*/)
{
...
bool KArchive::writeSymLink_impl(const QString & /*name*/, const QString & /*target*/, const QString & /*user*/, const QString & /*group*/,
                                 mode_t /*perm*/, time_t /*atime*/, time_t /*mtime*/, time_t /*ctime*/)
{
    kdWarning(7040) << "writeSymLink not implemented in this class." << endl << "No fallback available." << endl;
...
KArchiveDirectory *KArchive::findOrCreate(const QString &path)
{
    ...
    KArchiveDirectory *e =
        new KArchiveDirectory(this, dirname, d->rootDir->permissions(), d->rootDir->date(), d->rootDir->user(), d->rootDir->group(), QString::null);
    parent->addEntry(e);
...
/////////////////////// KArchiveEntry //////////////////////////////////
////////////////////////////////////////////////////////////////////////
KArchiveEntry::KArchiveEntry(KArchive *t, const QString &name, int access, int date, const QString &user, const QString &group,
...
KArchiveFile::KArchiveFile(KArchive *t, const QString &name, int access, int date, const QString &user, const QString &group, const QString &symlink,
                           int pos, int size)
...
KArchiveDirectory::KArchiveDirectory(KArchive *t, const QString &name, int access, int date, const QString &user, const QString &group,
                                     const QString &symlink)
    : KArchiveEntry(t, name, access, date, user, group, symlink)
{
...
void KArchiveDirectory::addEntry(KArchiveEntry *entry)
{
    ...
    {
        kdWarning() << "KArchiveDirectory::addEntry: directory " << name() << " has entry " << entry->name() << " already" << endl;
    }
...
void KArchive::virtual_hook(int id, void *data)
{
    switch(id)
    {
        ...
        case VIRTUAL_WRITE_FILE:
        {
            ...
            params->retval = writeFile_impl(*params->name, *params->user, *params->group, params->size, params->perm, params->atime, params->mtime,
                                            params->ctime, params->data);
            break;
        }
