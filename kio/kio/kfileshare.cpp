...
KFileSharePrivate::KFileSharePrivate()
{
    ...
    connect(KDirWatch::self(), SIGNAL(created(const QString &)), this, SLOT(slotFileChange(const QString &)));
    connect(KDirWatch::self(), SIGNAL(deleted(const QString &)), this, SLOT(slotFileChange(const QString &)));
}
