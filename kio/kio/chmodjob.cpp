...
ChmodJob::ChmodJob(const KFileItemList &lstItems, int permissions, int mask, int newOwner, int newGroup, bool recursive, bool showProgressInfo)
...
KIO_EXPORT ChmodJob *KIO::chmod(const KFileItemList &lstItems, int permissions, int mask, QString owner, QString group, bool recursive,
