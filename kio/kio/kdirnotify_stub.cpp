...
KDirNotify_stub::KDirNotify_stub(DCOPClient *client, const QCString &app, const QCString &obj) : DCOPStub(client, app, obj)
{
}

KDirNotify_stub::KDirNotify_stub(const DCOPRef &ref) : DCOPStub(ref)
{
}
