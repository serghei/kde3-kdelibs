...
DataSlave::DataSlave() : Slave(true, 0, "data", QString::null)
{
...
void DataSlave::send(int cmd, const QByteArray &arr)
{
    ...
    switch(cmd)
    {
        ...
        case CMD_SUBURL:
            break;
        default:
            error(ERR_UNSUPPORTED_ACTION, unsupportedActionErrorString(QString::fromLatin1("data"), cmd));
    } /*end switch*/
}
...
void DataSlave::setHost(const QString & /*host*/, int /*port*/, const QString & /*user*/, const QString & /*passwd*/)
{
