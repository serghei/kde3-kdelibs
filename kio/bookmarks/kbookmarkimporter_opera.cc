...
{
    return saving ? KFileDialog::getSaveFileName(QDir::homeDirPath() + "/.opera", i18n("*.adr|Opera Bookmark Files (*.adr)"))
                  : KFileDialog::getOpenFileName(QDir::homeDirPath() + "/.opera", i18n("*.adr|Opera Bookmark Files (*.adr)"));
}
