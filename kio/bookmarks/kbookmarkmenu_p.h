...
public:
    KImportedBookmarksActionMenu(const QString &text, const QString &sIconName, KActionCollection *parent, const char *name)
...
public:
    KBookmarkActionMenu(const QString &text, const QString &sIconName, KActionCollection *parent, const char *name)
        : KActionMenu(text, sIconName, parent, name)
    {
        ;
    }
...
public:
    // KDE4: remove
    KBookmarkAction(const QString &text, const QString &sIconName, const KShortcut &cut, const QObject *receiver, const char *slot,
                    KActionCollection *parent, const char *name)
        : KAction(text, sIconName, cut, receiver, slot, parent, name)
    {
    }
    KBookmarkAction(const QString &text, const QString &sIconName, const KShortcut &cut, KActionCollection *parent, const char *name)
...
public:
    ...
    KBookmarkEditDialog(const QString &title, const QString &url, KBookmarkManager *, BookmarkEditType editType,
                        const QString &address = QString::null, QWidget * = 0, const char * = 0, const QString &caption = i18n("Add Bookmark"));
