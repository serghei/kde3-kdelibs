...
{
    connect(src, SIGNAL(newBookmark(const QString &, const QCString &, const QString &)), dst,
            SIGNAL(newBookmark(const QString &, const QCString &, const QString &)));
    connect(src, SIGNAL(newFolder(const QString &, bool, const QString &)), dst, SIGNAL(newFolder(const QString &, bool, const QString &)));
