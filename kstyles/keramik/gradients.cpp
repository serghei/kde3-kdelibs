...
*/
// $Id: gradients.cpp 465272 2005-09-29 09:47:40Z mueller $
...
struct GradientCacheEntry
{
    ...
    {
        return ((m_width == other.m_width) && (m_height == other.m_height) && (m_menu == other.m_menu) && (m_color == other.m_color));
    }
...
void GradientPainter::renderGradient(QPainter *p, const QRect &r, QColor c, bool horizontal, bool menu, int px, int py, int pwidth, int pheight)
{
    ...
    cacheOK = cache.insert(imgToAdd->key(), imgToAdd, imgToAdd->m_pixmap->width() * imgToAdd->m_pixmap->height() * imgToAdd->m_pixmap->depth() / 8);
