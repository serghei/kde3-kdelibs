...
KateConfigPage::KateConfigPage(QWidget *parent, const char *name) : Kate::ConfigPage(parent, name), m_changed(false)
{
...
const int KateIndentConfigTab::flags[] = {KateDocument::cfSpaceIndent,       KateDocument::cfKeepIndentProfile,
                                          KateDocument::cfKeepExtraSpaces,   KateDocument::cfTabIndents,
                                          KateDocument::cfBackspaceIndents,  KateDocumentConfig::cfDoxygenAutoTyping,
                                          KateDocumentConfig::cfMixedIndent, KateDocumentConfig::cfIndentPastedText};

KateIndentConfigTab::KateIndentConfigTab(QWidget *parent) : KateConfigPage(parent)
{
    ...
    // What is this? help
    QWhatsThis::add(opt[0], i18n("Check this if you want to indent with spaces rather than tabs."));
    QWhatsThis::add(opt[2], i18n("Indentations of more than the selected number of spaces will not be "
                                 "shortened."));
    QWhatsThis::add(opt[3], i18n("This allows the <b>Tab</b> key to be used to increase the indentation "
                                 "level."));
    QWhatsThis::add(opt[4], i18n("This allows the <b>Backspace</b> key to be used to decrease the "
                                 "indentation level."));
    QWhatsThis::add(opt[5], i18n("Automatically inserts a leading \"*\" while typing within a Doxygen "
                                 "style comment."));
    QWhatsThis::add(opt[6], i18n("Use a mix of tab and space characters for indentation."));
    QWhatsThis::add(opt[7], i18n("If this option is selected, pasted code from the clipboard is indented. "
                                 "Triggering the <b>undo</b>-action removes the indentation."));
    QWhatsThis::add(indentationWidth, i18n("The number of spaces to indent with."));

    QWhatsThis::add(m_configPage, i18n("If this button is enabled, additional indenter specific options are "
...
void KateIndentConfigTab::configPage()
{
    ...
    {
        KDialogBase dlg(this, "indenter_config_dialog", true, i18n("Configure Indenter"), KDialogBase::Ok | KDialogBase::Cancel, KDialogBase::Cancel,
                        true);
...
KateSelectConfigTab::KateSelectConfigTab(QWidget *parent) : KateConfigPage(parent)
{
    int configFlags = KateDocumentConfig::global()->configFlags();
    ...
    QWhatsThis::add(rb1, i18n("Selections will be overwritten by typed text and will be lost on "
                              "cursor movement."));
    QWhatsThis::add(rb2, i18n("Selections will stay even after cursor movement and typing."));

    QWhatsThis::add(e4, i18n("Sets the number of lines to maintain visible above and below the "
                             "cursor when possible."));

    QWhatsThis::add(opt[0], i18n("When selected, pressing the home key will cause the cursor to skip "
                                 "whitespace and go to the start of a line's text. "
                                 "The same applies for the end key."));

    QWhatsThis::add(opt[1], i18n("When on, moving the insertion cursor using the <b>Left</b> and "
    ...
    QWhatsThis::add(
        e6, i18n("Selects whether the PageUp and PageDown keys should alter the vertical position of the cursor relative to the top of the view."));
...
const int KateEditConfigTab::flags[] = {KateDocument::cfWordWrap, KateDocument::cfAutoBrackets, KateDocument::cfShowTabs,
                                        KateDocumentConfig::cfReplaceTabsDyn, KateDocumentConfig::cfRemoveTrailingDyn};

KateEditConfigTab::KateEditConfigTab(QWidget *parent) : KateConfigPage(parent)
{
    ...
    // What is this? help
    QWhatsThis::add(opt[0], i18n("Automatically start a new line of text when the current line exceeds "
    ...
    QWhatsThis::add(e1, i18n("If the Word Wrap option is selected this entry determines the length "
                             "(in characters) at which the editor will automatically start a new line."));
    QWhatsThis::add(opt[1], i18n("When the user types a left bracket ([,(, or {) KateView automatically "
                                 "enters the right bracket (}, ), or ]) to the right of the cursor."));
    QWhatsThis::add(opt[2], i18n("The editor will display a symbol to indicate the presence of a tab in "
                                 "the text."));
    ...
    QWhatsThis::add(opt[3], i18n("If this is enabled, the editor will calculate the number of spaces up to "
                                 "the next tab position as defined by the tab width, and insert that number "
                                 "of spaces instead of a TAB character."));
    QWhatsThis::add(opt[4], i18n("If this is enabled, the editor will remove any trailing whitespace on "
                                 "lines when they are left by the insertion cursor."));
    QWhatsThis::add(m_wwmarker, i18n("<p>If this option is checked, a vertical line will be drawn at the word "
...
KateViewDefaultsConfig::KateViewDefaultsConfig(QWidget *parent) : KateConfigPage(parent)
{
    QRadioButton *rb1;
    QRadioButton *rb2;
    ...
    QWhatsThis::add(m_dynwrap, i18n("If this option is checked, the text lines will be wrapped at the view "
    ...
    // xgettext:no-c-format
    QWhatsThis::add(m_dynwrapAlignLevel, i18n("<p>Enables the start of dynamically wrapped lines to be aligned "
    ...
    QWhatsThis::add(m_line, i18n("If this option is checked, every new view will display line numbers "
                                 "on the left hand side."));
    QWhatsThis::add(m_icons, i18n("If this option is checked, every new view will display an icon border "
                                  "on the left hand side.<br><br>The icon border shows bookmark signs, "
                                  "for instance."));
    QWhatsThis::add(m_scrollBarMarks, i18n("If this option is checked, every new view will show marks on the "
                                           "vertical scrollbar.<br><br>These marks will, for instance, show "
                                           "bookmarks."));
    QWhatsThis::add(m_folding, i18n("If this option is checked, every new view will display marks for code "
    ...
    QWhatsThis::add(rb2, i18n("Each new bookmark will be added to the bottom, independently from "
                              "where it is placed in the document."));
    QWhatsThis::add(m_showIndentLines, i18n("If this is enabled, the editor will display vertical lines to help "
...
KateEditKeyConfiguration::KateEditKeyConfiguration(QWidget *parent, KateDocument *doc) : KateConfigPage(parent)
{
    m_doc = doc;
    m_ready = false;
}
...
KateSaveConfigTab::KateSaveConfigTab(QWidget *parent) : KateConfigPage(parent)
{
    int configFlags = KateDocumentConfig::global()->configFlags();
    QVBoxLayout *layout = new QVBoxLayout(this, 0, KDialog::spacingHint());
    ...
    QWhatsThis::add(removeSpaces, i18n("The editor will automatically eliminate extra spaces at the ends of "
                                       "lines of text while loading/saving the file."));
    QWhatsThis::add(gb, i18n("<p>Backing up on save will cause Kate to copy the disk file to "
                             "'&lt;prefix&gt;&lt;filename&gt;&lt;suffix&gt;' before saving changes."
                             "<p>The suffix defaults to <strong>~</strong> and prefix is empty by default"));
    QWhatsThis::add(allowEolDetection, i18n("Check this if you want the editor to autodetect the end of line type."
                                            "The first found end of line type will be used for the whole file."));
    QWhatsThis::add(cbLocalFiles, i18n("Check this if you want backups of local files when saving"));
    QWhatsThis::add(cbRemoteFiles, i18n("Check this if you want backups of remote files when saving"));
    QWhatsThis::add(leBuPrefix, i18n("Enter the prefix to prepend to the backup file names"));
    QWhatsThis::add(leBuSuffix, i18n("Enter the suffix to add to the backup file names"));
    QWhatsThis::add(dirSearchDepth, i18n("The editor will search the given number of folder levels upwards for .kateconfig file"
                                         " and load the settings line from it."));
    QWhatsThis::add(blockCount, i18n("The editor will load given number of blocks (of around 2048 lines) of text into memory;"
...
void KateSaveConfigTab::apply()
{
    ...
    {
        KMessageBox::information(this, i18n("You did not provide a backup suffix or prefix. Using default suffix: '~'"),
    ...
    if(removeSpaces->isChecked())
        configFlags |= KateDocument::cfRemoveSpaces; // set flag if checked

    KateDocumentConfig::global()->setConfigFlags(configFlags);

    KateDocumentConfig::global()->setEncoding((m_encoding->currentItem() == 0) ? ""
                                                                               : KGlobal::charsets()->encodingForName(m_encoding->currentText()));
...
KatePartPluginListItem::KatePartPluginListItem(bool checked, uint i, const QString &name, QListView *parent)
    : QCheckListItem(parent, name, CheckBox), index(i), silentStateChange(false)
{
...
KatePartPluginListView::KatePartPluginListView(QWidget *parent, const char *name) : KListView(parent, name)
{
}
...
KatePartPluginConfigPage::KatePartPluginConfigPage(QWidget *parent) : KateConfigPage(parent, "")
{
    ...
    connect(listView, SIGNAL(stateChange(KatePartPluginListItem *, bool)), this, SLOT(slotStateChanged(KatePartPluginListItem *, bool)));
...
void KatePartPluginConfigPage::slotConfigure()
{
    ...
    KTextEditor::ConfigInterfaceExtension *cife = KTextEditor::configInterfaceExtension(plugin);
    ...
    KDialogBase::DialogType dt = cife->configPages() > 1 ? KDialogBase::IconList : // still untested
                                     KDialogBase::Plain;

    QString name = (KateFactory::self()->plugins())[item->pluginIndex()]->name();
    KDialogBase *kd =
        new KDialogBase(dt, i18n("Configure %1").arg(name), KDialogBase::Ok | KDialogBase::Cancel | KDialogBase::Help, KDialogBase::Ok, this);
    ...
    for(uint i = 0; i < cife->configPages(); i++)
    {
        ...
        if(dt == KDialogBase::IconList)
        {
            ...
            page = kd->addVBoxPage(path, cife->configPageFullName(i), cife->configPagePixmap(i, KIcon::SizeMedium));
        }
        else
        {
            page = kd->plainPage();
...
KateHlConfigPage::KateHlConfigPage(QWidget *parent, KateDocument *doc) : KateConfigPage(parent, ""), hlData(0), m_doc(doc)
{
    QVBoxLayout *layout = new QVBoxLayout(this, 0, KDialog::spacingHint());
    ...
    QWhatsThis::add(hlCombo, i18n("Choose a <em>Syntax Highlight mode</em> from this list to view its "
                                  "properties below."));
    QWhatsThis::add(wildcards, i18n("The list of file extensions used to determine which files to highlight "
                                    "using the current syntax highlight mode."));
    QWhatsThis::add(mimetypes, i18n("The list of Mime Types used to determine which files to highlight "
    ...
    QWhatsThis::add(btnMTW, i18n("Display a dialog with a list of all available mime types to choose from."
                                 "<p>The <strong>File Extensions</strong> entry will automatically be "
                                 "edited as well."));
    QWhatsThis::add(btnDl, i18n("Click this button to download new or updated syntax highlight "
...
{
    QString text = i18n(
                       "Select the MimeTypes you want highlighted using the '%1' syntax highlight rules.\nPlease note that this will automatically "
                       "edit the associated file extensions as well.")
    ...
    : KDialogBase(KDialogBase::Swallow, i18n("Highlight Download"), User1 | Close, User1, parent, name, modal, true, i18n("&Install"))
{
    ...
    transferJob = KIO::get(KURL(QString(HLDOWNLOADPATH) + QString("update-") + QString(KATEPART_VERSION) + QString(".xml")), true, true);
    connect(transferJob, SIGNAL(data(KIO::Job *, const QByteArray &)), this, SLOT(listDataReceived(KIO::Job *, const QByteArray &)));
...
void KateHlDownloadDialog::listDataReceived(KIO::Job *, const QByteArray &data)
{
    ...
    if(data.size() == 0)
    {
        if(listData.length() > 0)
        {
            ...
            if(n.isNull())
                kdDebug(13000) << "There is no usable childnode" << endl;
            while(!n.isNull())
            {
                installedVersion = "    --";
                ...
                QListViewItem *entry = new QListViewItem(list, "", e.attribute("name"), installedVersion, e.attribute("version"), e.attribute("url"));
...
KateGotoLineDialog::KateGotoLineDialog(QWidget *parent, int line, int max) : KDialogBase(parent, 0L, true, i18n("Go to Line"), Ok | Cancel, Ok)
{
...
KateModOnHdPrompt::KateModOnHdPrompt(KateDocument *doc, int modtype, const QString &reason, QWidget *parent)
    : KDialogBase(parent, "", true, "", Ok | Apply | Cancel | User1), m_doc(doc), m_modtype(modtype), m_tmpfile(0)
{
    ...
    if(modtype != 3)
    {
        ...
        QWhatsThis::add(btnDiff, i18n("Calculates the difference between the editor contents and the disk "
...
{
    if(KMessageBox::warningContinueCancel(this, i18n("Ignoring means that you will not be warned again (unless "
                                          ...
                                          i18n("You Are on Your Own"), KStdGuiItem::cont(), "kate_ignore_modonhd")
