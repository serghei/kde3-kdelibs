...
// BEGIN KateConfig
KateConfig::KateConfig() : configSessionNumber(0), configIsRunning(false)
{
}
...
void KateDocumentConfig::readConfig(KConfig *config)
{
    ...
    setConfigFlags(config->readNumEntry("Basic Config Flags", KateDocumentConfig::cfTabIndents | KateDocumentConfig::cfKeepIndentProfile
                                                                  | KateDocumentConfig::cfWrapCursor | KateDocumentConfig::cfShowTabs
                                                                  | KateDocumentConfig::cfSmartHome | KateDocumentConfig::cfIndentPastedText));
...
void KateViewConfig::readConfig(KConfig *config)
{
    ...
    setSearchFlags(
        config->readNumEntry("Search Config Flags", KFindDialog::FromCursor | KFindDialog::CaseSensitive | KReplaceDialog::PromptOnReplace));
