...
{
    connect(m_doc, SIGNAL(undoChanged()), this, SLOT(slotNewUndo()));
    connect(m_doc, SIGNAL(hlChanged()), this, SLOT(slotHlChanged()));
    connect(m_doc, SIGNAL(canceled(const QString &)), this, SLOT(slotSaveCanceled(const QString &)));
...
void KateView::setupActions()
{
    ...
    if(!m_doc->readOnly())
    {
        ...
        (new KAction(i18n("&Word Wrap Document"), "", 0, this, SLOT(applyWordWrap()), ac, "tools_apply_wordwrap"))
            ->setWhatsThis(i18n("Use this command to wrap all lines of the current document which are longer than the width of the"
        ...
        a = new KAction(i18n("C&omment"), CTRL + Qt::Key_D, this, SLOT(comment()), ac, "tools_comment");
        a->setWhatsThis(
            i18n("This command comments out the current line or a selected block of text.<BR><BR>"
                 "The characters for single/multiple line comments are defined within the language's highlighting."));

        a = new KAction(i18n("Unco&mment"), CTRL + SHIFT + Qt::Key_D, this, SLOT(uncomment()), ac, "tools_uncomment");
        a->setWhatsThis(
            i18n("This command removes comments from the current line or a selected block of text.<BR><BR>"
                 "The characters for single/multiple line comments are defined within the language's highlighting."));
        a = m_toggleWriteLock = new KToggleAction(i18n("&Read Only Mode"), 0, 0, this, SLOT(toggleWriteLock()), ac, "tools_toggle_write_lock");
        a->setWhatsThis(i18n("Lock/unlock the document for writing"));

        a = new KAction(i18n("Uppercase"), CTRL + Qt::Key_U, this, SLOT(uppercase()), ac, "tools_uppercase");
        a->setWhatsThis(
            i18n("Convert the selection to uppercase, or the character to the "
                 "right of the cursor if no text is selected."));

        a = new KAction(i18n("Lowercase"), CTRL + SHIFT + Qt::Key_U, this, SLOT(lowercase()), ac, "tools_lowercase");
        a->setWhatsThis(
            i18n("Convert the selection to lowercase, or the character to the "
                 "right of the cursor if no text is selected."));

        a = new KAction(i18n("Capitalize"), CTRL + ALT + Qt::Key_U, this, SLOT(capitalize()), ac, "tools_capitalize");
        a->setWhatsThis(
            i18n("Capitalize the selection, or the word under the "
                 "cursor if no text is selected."));

        a = new KAction(i18n("Join Lines"), CTRL + Qt::Key_J, this, SLOT(joinLines()), ac, "tools_join_lines");
    }
    else
    {
    ...
    a = m_toggleBlockSelection =
        new KToggleAction(i18n("Bl&ock Selection Mode"), CTRL + SHIFT + Key_B, this, SLOT(toggleBlockSelectionMode()), ac, "set_verticalSelect");
    ...
    a = m_toggleInsert = new KToggleAction(i18n("Overwr&ite Mode"), Key_Insert, this, SLOT(toggleInsert()), ac, "set_insert");
    ...
    a = m_toggleDynWrap = toggleAction =
        new KToggleAction(i18n("&Dynamic Word Wrap"), Key_F10, this, SLOT(toggleDynWordWrap()), ac, "view_dynamic_word_wrap");
    ...
    a = toggleAction = m_toggleFoldingMarkers =
        new KToggleAction(i18n("Show Folding &Markers"), Key_F9, this, SLOT(toggleFoldingMarkers()), ac, "view_folding_markers");
    ...
    a = m_toggleIconBar = toggleAction = new KToggleAction(i18n("Show &Icon Border"), Key_F6, this, SLOT(toggleIconBorder()), ac, "view_border");
    a = toggleAction;
    ...
    a = m_toggleScrollBarMarks = toggleAction =
        new KToggleAction(i18n("Show Scroll&bar Marks"), 0, this, SLOT(toggleScrollBarMarks()), ac, "view_scrollbar_marks");
    ...
    a = toggleAction = m_toggleWWMarker =
        new KToggleAction(i18n("Show Static &Word Wrap Marker"), 0, this, SLOT(toggleWWMarker()), ac, "view_word_wrap_marker");
    a->setWhatsThis(
    ...
    a = m_switchCmdLine = new KAction(i18n("Switch to Command Line"), Key_F7, this, SLOT(switchToCmdLine()), ac, "switch_to_cmd_line");
...
void KateView::setupEditActions()
{
    ...
    new KAction(i18n("Move Word Left"), CTRL + Key_Left, this, SLOT(wordLeft()), ac, "word_left");
    new KAction(i18n("Select Character Left"), SHIFT + Key_Left, this, SLOT(shiftCursorLeft()), ac, "select_char_left");
    new KAction(i18n("Select Word Left"), SHIFT + CTRL + Key_Left, this, SLOT(shiftWordLeft()), ac, "select_word_left");

    new KAction(i18n("Move Word Right"), CTRL + Key_Right, this, SLOT(wordRight()), ac, "word_right");
    new KAction(i18n("Select Character Right"), SHIFT + Key_Right, this, SLOT(shiftCursorRight()), ac, "select_char_right");
    new KAction(i18n("Select Word Right"), SHIFT + CTRL + Key_Right, this, SLOT(shiftWordRight()), ac, "select_word_right");

    new KAction(i18n("Move to Beginning of Line"), Key_Home, this, SLOT(home()), ac, "beginning_of_line");
    new KAction(i18n("Move to Beginning of Document"), KStdAccel::home(), this, SLOT(top()), ac, "beginning_of_document");
    new KAction(i18n("Select to Beginning of Line"), SHIFT + Key_Home, this, SLOT(shiftHome()), ac, "select_beginning_of_line");
    new KAction(i18n("Select to Beginning of Document"), SHIFT + CTRL + Key_Home, this, SLOT(shiftTop()), ac, "select_beginning_of_document");

    new KAction(i18n("Move to End of Line"), Key_End, this, SLOT(end()), ac, "end_of_line");
    new KAction(i18n("Move to End of Document"), KStdAccel::end(), this, SLOT(bottom()), ac, "end_of_document");
    new KAction(i18n("Select to End of Line"), SHIFT + Key_End, this, SLOT(shiftEnd()), ac, "select_end_of_line");
    new KAction(i18n("Select to End of Document"), SHIFT + CTRL + Key_End, this, SLOT(shiftBottom()), ac, "select_end_of_document");

    new KAction(i18n("Select to Previous Line"), SHIFT + Key_Up, this, SLOT(shiftUp()), ac, "select_line_up");
    new KAction(i18n("Scroll Line Up"), "", CTRL + Key_Up, this, SLOT(scrollUp()), ac, "scroll_line_up");

    new KAction(i18n("Move to Next Line"), Key_Down, this, SLOT(down()), ac, "move_line_down");

    new KAction(i18n("Move to Previous Line"), Key_Up, this, SLOT(up()), ac, "move_line_up");

    new KAction(i18n("Move Character Right"), Key_Right, this, SLOT(cursorRight()), ac, "move_cursor_right");

    new KAction(i18n("Move Character Left"), Key_Left, this, SLOT(cursorLeft()), ac, "move_cusor_left");

    new KAction(i18n("Select to Next Line"), SHIFT + Key_Down, this, SLOT(shiftDown()), ac, "select_line_down");
    new KAction(i18n("Scroll Line Down"), CTRL + Key_Down, this, SLOT(scrollDown()), ac, "scroll_line_down");

    new KAction(i18n("Scroll Page Up"), KStdAccel::prior(), this, SLOT(pageUp()), ac, "scroll_page_up");
    new KAction(i18n("Select Page Up"), SHIFT + Key_PageUp, this, SLOT(shiftPageUp()), ac, "select_page_up");
    new KAction(i18n("Move to Top of View"), CTRL + Key_PageUp, this, SLOT(topOfView()), ac, "move_top_of_view");
    new KAction(i18n("Select to Top of View"), CTRL + SHIFT + Key_PageUp, this, SLOT(shiftTopOfView()), ac, "select_top_of_view");

    new KAction(i18n("Scroll Page Down"), KStdAccel::next(), this, SLOT(pageDown()), ac, "scroll_page_down");
    new KAction(i18n("Select Page Down"), SHIFT + Key_PageDown, this, SLOT(shiftPageDown()), ac, "select_page_down");
    new KAction(i18n("Move to Bottom of View"), CTRL + Key_PageDown, this, SLOT(bottomOfView()), ac, "move_bottom_of_view");
    new KAction(i18n("Select to Bottom of View"), CTRL + SHIFT + Key_PageDown, this, SLOT(shiftBottomOfView()), ac, "select_bottom_of_view");
    new KAction(i18n("Move to Matching Bracket"), CTRL + Key_6, this, SLOT(toMatchingBracket()), ac, "to_matching_bracket");
    new KAction(i18n("Select to Matching Bracket"), SHIFT + CTRL + Key_6, this, SLOT(shiftToMatchingBracket()), ac, "select_matching_bracket");

    // anders: shortcuts doing any changes should not be created in browserextension
    if(!m_doc->readOnly())
    {
        new KAction(i18n("Transpose Characters"), CTRL + Key_T, this, SLOT(transpose()), ac, "transpose_char");

        new KAction(i18n("Delete Line"), CTRL + Key_K, this, SLOT(killLine()), ac, "delete_line");

        new KAction(i18n("Delete Word Left"), KStdAccel::deleteWordBack(), this, SLOT(deleteWordLeft()), ac, "delete_word_left");

        new KAction(i18n("Delete Word Right"), KStdAccel::deleteWordForward(), this, SLOT(deleteWordRight()), ac, "delete_word_right");

        new KAction(i18n("Delete Next Character"), Key_Delete, this, SLOT(keyDelete()), ac, "delete_next_character");

        KAction *a = new KAction(i18n("Backspace"), Key_Backspace, this, SLOT(backspace()), ac, "backspace");
        KShortcut cut = a->shortcut();
        cut.append(KKey(SHIFT + Key_Backspace));
        a->setShortcut(cut);
    }

    connect(this, SIGNAL(gotFocus(Kate::View *)), this, SLOT(slotGotFocus()));
    connect(this, SIGNAL(lostFocus(Kate::View *)), this, SLOT(slotLostFocus()));
...
{
    KActionCollection *ac = this->actionCollection();
    new KAction(i18n("Collapse Toplevel"), CTRL + SHIFT + Key_Minus, m_doc->foldingTree(), SLOT(collapseToplevelNodes()), ac, "folding_toplevel");
    new KAction(i18n("Expand Toplevel"), CTRL + SHIFT + Key_Plus, this, SLOT(slotExpandToplevel()), ac, "folding_expandtoplevel");
    new KAction(i18n("Collapse One Local Level"), CTRL + Key_Minus, this, SLOT(slotCollapseLocal()), ac, "folding_collapselocal");
    new KAction(i18n("Expand One Local Level"), CTRL + Key_Plus, this, SLOT(slotExpandLocal()), ac, "folding_expandlocal");
...
void KateView::setupCodeCompletion()
{
    ...
    connect(m_codeCompletion, SIGNAL(filterInsertString(KTextEditor::CompletionEntry *, QString *)), this,
...
void KateView::contextMenuEvent(QContextMenuEvent *ev)
{
    if(!m_doc || !m_doc->browserExtension())
        return;
    emit m_doc->browserExtension()->popupMenu(/*this, */ ev->globalPos(), m_doc->url(), QString::fromLatin1("text/plain"));
    ev->accept();
}
...
KateView::saveResult KateView::saveAs()
{
    ...
    KEncodingFileDialog::Result res =
        KEncodingFileDialog::getSaveURLAndEncoding(doc()->config()->encoding(), m_doc->url().url(), QString::null, this, i18n("Save File"));
...
bool KateView::checkOverwrite(KURL u)
{
    ...
    return KMessageBox::Continue == KMessageBox::warningContinueCancel(
                                        this, i18n("A file named \"%1\" already exists. Are you sure you want to overwrite it?").arg(info.fileName()),
                                        i18n("Overwrite File?"), KGuiItem(i18n("&Overwrite"), "filesave", i18n("Overwrite the file")));
}
...
bool KateView::lineColSelected(int line, int col)
{
    ...
    if(blockSelect)
        return cursor.line() >= selectStart.line() && cursor.line() <= selectEnd.line() && cursor.col() >= selectStart.col()
               && cursor.col() < selectEnd.col();
    else
...
{
    return (!blockSelect) && (selectStart <= KateTextCursor(line, 0)) && (line < selectEnd.line());
}

bool KateView::lineEndSelected(int line, int endCol)
{
    return (!blockSelect) && (line > selectStart.line() || (line == selectStart.line() && (selectStart.col() < endCol || endCol == -1)))
           && (line < selectEnd.line() || (line == selectEnd.line() && (endCol <= selectEnd.col() && endCol != -1)));
}

bool KateView::lineHasSelected(int line)
{
    return (selectStart < selectEnd) && (line >= selectStart.line()) && (line <= selectEnd.line());
}
...
void KateView::selectWord(const KateTextCursor &cursor)
{
    ...
    while(start > 0 && m_doc->highlight()->isInWord(textLine->getChar(start - 1), textLine->attribute(start - 1)))
        start--;
    while(end < len && m_doc->highlight()->isInWord(textLine->getChar(end), textLine->attribute(start - 1)))
        end++;
    if(end <= start)
        return;
...
void KateView::lineAsHTML(KateTextLine::Ptr line, uint startCol, uint length, QTextStream *outputStream)
{
    ...
    for(uint curPos = startCol; curPos < (length + startCol); curPos++)
    {
                  ...
                  KateAttribute(*charAttributes) != KateAttribute(*m_renderer->attribute(line->attribute(curPos))))
        {
            ...
            (*outputStream) << "<span style=\"" << stylecache[line->attribute(curPos)] << "\">";
        }
...
void KateView::setIMSelectionValue(uint imStartLine, uint imStart, uint imEnd, uint imSelStart, uint imSelEnd, bool imComposeEvent)
{
...
{
    return ((int(m_imStartLine) == _line) && (m_imSelStart < m_imSelEnd) && (_column >= int(m_imSelStart)) && (_column < int(m_imSelEnd)));
}

bool KateView::isIMEdit(int _line, int _column)
{
    return ((int(m_imStartLine) == _line) && (m_imStart < m_imEnd) && (_column >= int(m_imStart)) && (_column < int(m_imEnd)));
}

void KateView::getIMSelectionValue(uint *imStartLine, uint *imStart, uint *imEnd, uint *imSelStart, uint *imSelEnd)
{
