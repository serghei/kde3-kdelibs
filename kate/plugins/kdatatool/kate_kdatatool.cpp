...
KDataToolPlugin::KDataToolPlugin(QObject *parent, const char *name, const QStringList &) : KTextEditor::Plugin((KTextEditor::Document *)parent, name)
{
}
...
KDataToolPluginView::KDataToolPluginView(KTextEditor::View *view) : m_menu(0), m_notAvailable(0)
{
...
void KDataToolPluginView::aboutToShow()
{
    ...
    else
    {
        ...
        {
            m_notAvailable = new KAction(i18n("(not available)"), QString::null, 0, this, SLOT(slotNotAvailable()), actionCollection(), "dt_n_av");
    ...
    m_actionList = KDataToolAction::dataToolActionList(tools, this, SLOT(slotToolActivated(const KDataToolInfo &, const QString &)));
