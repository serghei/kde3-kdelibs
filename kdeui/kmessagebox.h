...
public:
    ...
    static int questionYesNo(QWidget *parent, const QString &text, const QString &caption = QString::null,
                             const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
     ...
     * @since 3.2
     */
    static int questionYesNoWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                                const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                const QString &dontAskAgainName = QString::null, int options = Notify);
    /**
     * Display a simple "question" dialog.
    ...
    static int questionYesNoCancel(QWidget *parent, const QString &text, const QString &caption = QString::null,
                                   const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                   const QString &dontAskAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static int questionYesNoCancelWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                                      const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                      const QString &dontAskAgainName = QString::null, int options = Notify);
    ...
    static int questionYesNoList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                 const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                 const QString &dontAskAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static int questionYesNoListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                    const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                    const QString &dontAskAgainName = QString::null, int options = Notify);
    ...
    static int warningYesNo(QWidget *parent, const QString &text, const QString &caption = QString::null,
                            const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                            const QString &dontAskAgainName = QString::null, int options = Notify | Dangerous);
     ...
     * @since 3.2
     */
    static int warningYesNoWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                               const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                               const QString &dontAskAgainName = QString::null, int options = Notify | Dangerous);
    ...
    static int warningYesNoList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                const QString &dontAskAgainName = QString::null, int options = Notify | Dangerous);
     ...
     * @since 3.2
     */
    static int warningYesNoListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                   const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                   const QString &dontAskAgainName = QString::null, int options = Notify | Dangerous);
    ...
    static int warningContinueCancel(QWidget *parent, const QString &text, const QString &caption = QString::null,
                                     const KGuiItem &buttonContinue = KStdGuiItem::cont(), const QString &dontAskAgainName = QString::null,
                                     int options = Notify);
     ...
     * @since 3.2
     */
    static int warningContinueCancelWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                                        const KGuiItem &buttonContinue = KStdGuiItem::cont(), const QString &dontAskAgainName = QString::null,
                                        int options = Notify);
     ...
     * The default button is buttonContinue. Pressing "Esc" selects "Cancel".
     */
    static int warningContinueCancelList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                         const KGuiItem &buttonContinue = KStdGuiItem::cont(), const QString &dontAskAgainName = QString::null,
                                         int options = Notify);
     ...
     * @since 3.2
     */
    static int warningContinueCancelListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                            const KGuiItem &buttonContinue = KStdGuiItem::cont(), const QString &dontAskAgainName = QString::null,
                                            int options = Notify);
    ...
    static int warningYesNoCancel(QWidget *parent, const QString &text, const QString &caption = QString::null,
                                  const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                  const QString &dontAskAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static int warningYesNoCancelWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                                     const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                     const QString &dontAskAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static int warningYesNoCancelList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                      const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                      const QString &dontAskAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static int warningYesNoCancelListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                         const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                                         const QString &dontAskAgainName = QString::null, int options = Notify);
    ...
    static void errorList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                          int options = Notify);
    ...
    static void errorListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                             int options = Notify);
     ...
     * NOTE: The OK button will always have the i18n'ed text '&OK'.
     */
    static void detailedError(QWidget *parent, const QString &text, const QString &details, const QString &caption = QString::null,
                              int options = Notify);
     ...
     * @since 3.2
     */
    static void detailedErrorWId(WId parent_id, const QString &text, const QString &details, const QString &caption = QString::null,
                                 int options = Notify);
    ...
    static void detailedSorry(QWidget *parent, const QString &text, const QString &details, const QString &caption = QString::null,
                              int options = Notify);
     ...
     * @since 3.2
     */
    static void detailedSorryWId(WId parent_id, const QString &text, const QString &details, const QString &caption = QString::null,
                                 int options = Notify);
    ...
    static void information(QWidget *parent, const QString &text, const QString &caption = QString::null,
                            const QString &dontShowAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static void informationWId(WId parent_id, const QString &text, const QString &caption = QString::null,
                               const QString &dontShowAgainName = QString::null, int options = Notify);
    ...
    static void informationList(QWidget *parent, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                const QString &dontShowAgainName = QString::null, int options = Notify);
     ...
     * @since 3.2
     */
    static void informationListWId(WId parent_id, const QString &text, const QStringList &strlist, const QString &caption = QString::null,
                                   const QString &dontShowAgainName = QString::null, int options = Notify);
     ...
     */
    static int messageBox(QWidget *parent, DialogType type, const QString &text, const QString &caption, const KGuiItem &buttonYes,
                          const KGuiItem &buttonNo, const QString &dontShowAskAgainName, int options = Notify);
    ...
    static int messageBox(QWidget *parent, DialogType type, const QString &text, const QString &caption = QString::null,
                          const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(), int options = Notify);
     ...
     * @since 3.2
     */
    static int messageBoxWId(WId parent_id, DialogType type, const QString &text, const QString &caption = QString::null,
                             const KGuiItem &buttonYes = KStdGuiItem::yes(), const KGuiItem &buttonNo = KStdGuiItem::no(),
                             const QString &dontShowAskAgainName = QString::null, int options = Notify);
     ...
     */
    static int createKMessageBox(KDialogBase *dialog, QMessageBox::Icon icon, const QString &text, const QStringList &strlist, const QString &ask,
                                 bool *checkboxReturn, int options, const QString &details = QString::null);
     ...
     *         function. Do not delete it yourself.
     */
    static int createKMessageBox(KDialogBase *dialog, QPixmap icon, const QString &text, const QStringList &strlist, const QString &ask,
                                 bool *checkboxReturn, int options, const QString &details = QString::null,
