...
QString KStdGuiItem::stdItem(StdItem ui_enum)
{
    switch(ui_enum)
    {
        ...
        case Discard:
            return QString::fromLatin1("discard");
        case Save:
            return QString::fromLatin1("save");
        case DontSave:
            return QString::fromLatin1("dontSave");
        case SaveAs:
            return QString::fromLatin1("saveAs");
        case Apply:
            return QString::fromLatin1("apply");
        case Help:
            return QString::fromLatin1("help");
        case Close:
            return QString::fromLatin1("close");
        case Defaults:
            return QString::fromLatin1("defaults");
        case Back:
            return QString::fromLatin1("back");
        case Forward:
            return QString::fromLatin1("forward");
        case Print:
            return QString::fromLatin1("print");
        case Continue:
            return QString::fromLatin1("continue");
        case Open:
            return QString::fromLatin1("open");
        case Quit:
            return QString::fromLatin1("quit");
        case AdminMode:
            return QString::fromLatin1("adminMode");
        case Delete:
            return QString::fromLatin1("delete");
        case Insert:
            return QString::fromLatin1("insert");
        case Find:
            return QString::fromLatin1("find");
        case Stop:
            return QString::fromLatin1("stop");
        case Add:
            return QString::fromLatin1("add");
        case Remove:
            return QString::fromLatin1("remove");
        case Test:
            return QString::fromLatin1("test");
        case Properties:
            return QString::fromLatin1("properties");
        case Overwrite:
            return QString::fromLatin1("overwrite");
        default:
            return QString::null;
    };
}
...
{
    return KGuiItem(i18n("&Discard"), "", i18n("Discard changes"), i18n("Pressing this button will discard all recent "
...
{
    return KGuiItem(i18n("&Do Not Save"), "", i18n("Don't save data"));
}

KGuiItem KStdGuiItem::saveAs()
{
    return KGuiItem(i18n("Save &As..."), "filesaveas", i18n("Save file with another name"));
}

KGuiItem KStdGuiItem::apply()
{
    return KGuiItem(i18n("&Apply"), "apply", i18n("Apply changes"), i18n("When clicking <b>Apply</b>, the settings will be "
...
{
    return KGuiItem(i18n("C&lear"), "locationbar_erase", i18n("Clear input"), i18n("Clear the input in the edit field"));
}

KGuiItem KStdGuiItem::help()
{
    return KGuiItem(i18n("show help", "&Help"), "help", i18n("Show help"));
}

KGuiItem KStdGuiItem::close()
{
    return KGuiItem(i18n("&Close"), "fileclose", i18n("Close the current window or document"));
}

KGuiItem KStdGuiItem::defaults()
{
    return KGuiItem(i18n("&Defaults"), "", i18n("Reset all items to their default values"));
}

KGuiItem KStdGuiItem::back(BidiMode useBidi)
{
    QString icon = (useBidi == UseRTL && QApplication::reverseLayout()) ? "forward" : "back";
    return KGuiItem(i18n("go back", "&Back"), icon, i18n("Go back one step"));
}

KGuiItem KStdGuiItem::forward(BidiMode useBidi)
{
    QString icon = (useBidi == UseRTL && QApplication::reverseLayout()) ? "back" : "forward";
    return KGuiItem(i18n("go forward", "&Forward"), icon, i18n("Go forward one step"));
}
...
{
    return KGuiItem(i18n("&Print..."), "fileprint", i18n("Opens the print dialog to print "
                                                         "the current document"));
}

KGuiItem KStdGuiItem::cont()
{
    return KGuiItem(i18n("C&ontinue"), QString::null, i18n("Continue operation"));
}

KGuiItem KStdGuiItem::del()
{
    return KGuiItem(i18n("&Delete"), "editdelete", i18n("Delete item(s)"));
}

KGuiItem KStdGuiItem::open()
{
    return KGuiItem(i18n("&Open..."), "fileopen", i18n("Open file"));
}

KGuiItem KStdGuiItem::quit()
{
    return KGuiItem(i18n("&Quit"), "exit", i18n("Quit application"));
}

KGuiItem KStdGuiItem::reset()
{
    return KGuiItem(i18n("&Reset"), "undo", i18n("Reset configuration"));
}
