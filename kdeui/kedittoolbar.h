...
public:
     ...
     */
    KEditToolbar(KActionCollection *collection, const QString &xmlfile = QString::null, bool global = true, QWidget *parent = 0,
                 const char *name = 0);
     ...
     * @since 3.2
     */
    KEditToolbar(const QString &defaultToolbar, KActionCollection *collection, const QString &xmlfile = QString::null, bool global = true,
...
public:
    ...
    * @since 3.2
    */
    KEditToolbarWidget(const QString &defaultToolbar, KActionCollection *collection, const QString &file = QString::null, bool global = true,
                       QWidget *parent = 0L);
...
protected: // KDE4: make private
    ...
    void insertActive(ns_KEditToolbar::ToolbarItem *item, QListViewItem *before, bool prepend = false);
    void removeActive(ns_KEditToolbar::ToolbarItem *item);
    void moveActive(ns_KEditToolbar::ToolbarItem *item, QListViewItem *before);
...
private:
    ns_KEditToolbar::ToolbarListView *m_inactiveList;
    ns_KEditToolbar::ToolbarListView *m_activeList;
