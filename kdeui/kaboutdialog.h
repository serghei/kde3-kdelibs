...
public:
    KAboutContainer(QWidget *parent = 0, const char *name = 0, int margin = 0, int spacing = 0, int childAlignment = AlignCenter,
                    int innerAlignment = AlignCenter);

    void addWidget(QWidget *widget);
    void addPerson(const QString &name, const QString &email, const QString &url, const QString &task, bool showHeader = false,
...
public:
    KAboutContributor(QWidget *parent = 0, const char *name = 0, const QString &username = QString::null, const QString &email = QString::null,
                      const QString &url = QString::null, const QString &work = QString::null, bool showHeader = false, bool showFrame = true,
                      bool showBold = false);
...
public:
     ...
     *
     */
    KAboutDialog(int dialogLayout, const QString &caption, int buttonMask, ButtonCode defaultButton, QWidget *parent = 0, const char *name = 0,
                 bool modal = false, bool separator = false, const QString &user1 = QString::null, const QString &user2 = QString::null,
