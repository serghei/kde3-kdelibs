...
KLanguageButton::KLanguageButton(QWidget *parent, const char *name) : QWidget(parent, name)
{
    init(name);
}

KLanguageButton::KLanguageButton(const QString &text, QWidget *parent, const char *name) : QWidget(parent, name)
{
    init(name);
...
void KLanguageButton::insertLanguage(const QString &path, const QString &name, const QString &, const QString &submenu, int index)
{
...
void KLanguageButton::insertItem(const QIconSet &icon, const QString &text, const QString &id, const QString &submenu, int index)
{
...
void KLanguageButton::insertItem(const QString &text, const QString &id, const QString &submenu, int index)
{
...
void KLanguageButton::insertSubmenu(const QIconSet &icon, const QString &text, const QString &id, const QString &submenu, int index)
{
    QPopupMenu *pi = checkInsertIndex(m_popup, m_ids, submenu);
    ...
    m_ids->append(id);
    connect(p, SIGNAL(activated(int)), SLOT(slotActivated(int)));
    connect(p, SIGNAL(highlighted(int)), this, SLOT(slotHighlighted(int)));
}

void KLanguageButton::insertSubmenu(const QString &text, const QString &id, const QString &submenu, int index)
{
...
void KLanguageButton::clear()
{
    ...
    connect(m_popup, SIGNAL(highlighted(int)), SLOT(slotHighlighted(int)));
