...
int main(int argc, char *argv[])
{
    ...
    svalue = KInputDialog::getText("_caption", "_label:", "_value", &ok, 0L, 0L, &QRegExpValidator(QRegExp("[0-9]{3}\\-[0-9]{3}\\-[0-9]{4}"), 0L));
    kdDebug() << "value2: " << svalue << ", ok: " << ok << endl;

    svalue = KInputDialog::getText("_caption", "_label:", "_value", &ok, 0L, 0L, 0L, "900.900.900.900");
    kdDebug() << "value1: " << svalue << ", ok: " << ok << endl;
    ...
    dvalue = KInputDialog::getDouble("_caption", "_label:", 10, 0, 100, 0.1, 2, &ok);
    ...
    list << "Item 6"
         ...
         << "Item 9"
         << "Item 10";
    slvalue = KInputDialog::getItemList("_caption", "_label:", list, select, false, &ok);
    kdDebug() << "value9: " << slvalue << ", ok: " << ok << endl;

    select << "Item 5";
    slvalue = KInputDialog::getItemList("_caption", "_label:", list, select, true, &ok);
