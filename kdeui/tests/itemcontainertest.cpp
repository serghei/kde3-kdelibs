...
static const char *item_xpm[] = {"22 22 3 1",
                                 " 	c None",
                                 ".	c #000000",
                                 "+	c #FF0000",
                                 "        ......        ",
...
TopLevel::TopLevel(QWidget *parent, const char *name) : QWidget(parent, name)
{
    ...
    connect(m_pbgMode, SIGNAL(clicked(int)), this, SLOT(slotSwitchMode(int)));
    ...
    connect(cbListView, SIGNAL(toggled(bool)), this, SLOT(slotToggleSingleColumn(bool)));
    ...
    hBox->addSpacing(5);
    connect(m_pIconView, SIGNAL(executed(QIconViewItem *)), this, SLOT(slotIconViewExec(QIconViewItem *)));
    ...
    hBox->addSpacing(5);
    connect(m_pListView, SIGNAL(executed(QListViewItem *)), this, SLOT(slotListViewExec(QListViewItem *)));

    // Create ListBox
    QGroupBox *gbListBox = new QGroupBox(1, Qt::Horizontal, "KListBox", this);
    m_pListBox = new KListBox(gbListBox);
    hBox->addWidget(gbListBox);
    connect(m_pListBox, SIGNAL(executed(QListBoxItem *)), this, SLOT(slotListBoxExec(QListBoxItem *)));
    ...
    connect(m_pIconView, SIGNAL(clicked(QIconViewItem *)), this, SLOT(slotClicked(QIconViewItem *)));
    connect(m_pIconView, SIGNAL(doubleClicked(QIconViewItem *)), this, SLOT(slotDoubleClicked(QIconViewItem *)));
}
