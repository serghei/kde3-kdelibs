...
TestWidget::TestWidget(QWidget *parent, const char *name) : QLabel(parent, name)
{
    testMenu = new KPanelAppMenu(locate("mini", "x.png"), "Client Test", this, "menu1");
...
{
    testMenu->insertItem(locate("mini", "bx2.png"), "Add another entry!", 1);
