...
ExampleWidget::ExampleWidget(QWidget *parent, const char *name) : QLabel(parent, name)
{
        ...
        switch(test)
        {
            case 1:
                ...
                i = KMessageBox::questionYesNo(0,
                                               "<p>Do you have a printer? thisisaverylongdkldhklghklghklashgkllasghkdlsghkldfghklsabla bla bbla bla. "
                                               "It also has <a href=http://www.kde.org>this URL</a>.</p>",
                                               QString("Bla"), QString("Yes"), QString("No"), "bla", KMessageBox::AllowLink);
                break;

            case 2:
                i = KMessageBox::questionYesNo(0, "Do you have a printer?", QString("Printer setup"), QString::null);
                break;

            case 3:
                i = KMessageBox::questionYesNo(0, "Does your printer support color or only black and white?", "Printer setup",
                                               QString::fromLatin1("&Color"), QString::fromLatin1("&Black & White"));
                break;
            ...
            case 15:
                ...
                KMessageBox::information(0,
                                         "You can enable the menubar again "
