...
int main(int argc, char **argv)
{
    ...
    // example 1
    {
        ...
        b->setDefault(true);
        w->connect(b, SIGNAL(clicked()), w, SLOT(accept()));
        w->connect(bbox->addButton("Cancel"), SIGNAL(clicked()), w, SLOT(accept()));
    ...
    // example 5
    {
        ...
        QVBoxLayout *tl = new QVBoxLayout(w, 5);
        QLabel *l = new QLabel(
            "A better solution for the bad example\n\n"
    ...
    // example 6
    {
        ...
        QLabel *l = new QLabel(
            "Did I mention that it's possible\n"
