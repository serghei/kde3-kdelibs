...
KAboutKDE::KAboutKDE(QWidget *parent, const char *name, bool modal)
    : KAboutDialog(KAboutDialog::AbtKDEStandard, QString::fromLatin1("KDE"), KDialogBase::Help | KDialogBase::Close, KDialogBase::Close, parent, name,
                   modal)
{
    ...
    setTitle(i18n("K Desktop Environment. Release %1").arg(QString::fromLatin1(KDE_VERSION_STRING)));
